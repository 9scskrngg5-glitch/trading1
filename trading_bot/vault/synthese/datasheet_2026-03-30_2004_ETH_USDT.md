...
> Généré le 30/03/2026 20:04 UTC | Prix : `2023.700000` | ATR : `19.705000` (0.97%)
...
| Votes LONG / SHORT / HOLD | `41%` / `43%` / `16%` |
...
**Note comportementale** : _📊 Distribution équilibrée (41%L / 43%S / 16%H). Pas de consensus clair — marché indécis selon le crowd._
