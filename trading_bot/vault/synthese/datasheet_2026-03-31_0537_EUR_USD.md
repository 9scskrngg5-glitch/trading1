...
> Généré le 31/03/2026 05:37 UTC | Prix : `1.147600` | ATR : `0.001036` (0.09%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.16% |
...
| LVN (Low Vol. Nodes) | `1.1476` | `1.1479` | `1.1482` |
...
| Votes LONG / SHORT / HOLD | `32%` / `48%` / `20%` |
