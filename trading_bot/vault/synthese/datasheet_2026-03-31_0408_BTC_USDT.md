...
> Généré le 31/03/2026 04:08 UTC | Prix : `67704.740000` | ATR : `529.318571` (0.78%)
...
| Votes LONG / SHORT / HOLD | `36%` / `40%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 40%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
