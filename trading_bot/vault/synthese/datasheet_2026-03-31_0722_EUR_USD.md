...
> Généré le 31/03/2026 07:22 UTC | Prix : `1.148100` | ATR : `0.001064` (0.09%)
...
| Votes LONG / SHORT / HOLD | `31%` / `51%` / `19%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (31%/51%). Prudence : la foule a souvent tort contre la structure._
