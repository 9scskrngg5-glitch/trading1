...
> Généré le 31/03/2026 01:41 UTC | Prix : `67208.750000` | ATR : `498.372857` (0.74%)
...
#### Sentiment Global
> POSITIVE — score `+23.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `30%` / `45%` / `26%` |
