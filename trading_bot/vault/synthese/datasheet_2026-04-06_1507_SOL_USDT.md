...
> Généré le 06/04/2026 15:07 UTC | Prix : `82.230000` | ATR : `0.682857` (0.83%)
...
#### Sentiment Global
> NEGATIVE — score `-21.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `37%` / `30%` / `33%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (37%/30%). Prudence : la foule a souvent tort contre la structure._
