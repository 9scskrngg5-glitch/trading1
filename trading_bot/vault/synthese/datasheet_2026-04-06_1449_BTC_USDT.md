...
> Généré le 06/04/2026 14:49 UTC | Prix : `69428.230000` | ATR : `391.775000` (0.56%)
...
| Votes LONG / SHORT / HOLD | `42%` / `17%` / `42%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (42%/17%). Prudence : la foule a souvent tort contre la structure._
