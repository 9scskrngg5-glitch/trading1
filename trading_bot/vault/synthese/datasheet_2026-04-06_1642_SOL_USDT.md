...
> Généré le 06/04/2026 16:42 UTC | Prix : `82.270000` | ATR : `0.662857` (0.81%)
...
| Votes LONG / SHORT / HOLD | `42%` / `30%` / `28%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (42%/30%). Prudence : la foule a souvent tort contre la structure._
