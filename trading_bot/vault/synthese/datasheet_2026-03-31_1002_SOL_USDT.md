...
> Généré le 31/03/2026 10:02 UTC | Prix : `80.550000` | ATR : `0.967857` (1.20%)
...
#### Sentiment Global
> POSITIVE — score `+28.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `34%` / `39%` / `26%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 39% SHORT avec support structurel. Consensus comportemental renforce l'analyse primaire._
