...
> Généré le 31/03/2026 04:55 UTC | Prix : `67704.740000` | ATR : `529.318571` (0.78%)
...
#### Sentiment Global
> NEUTRAL — score `+6.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `35%` / `46%` / `19%` |
