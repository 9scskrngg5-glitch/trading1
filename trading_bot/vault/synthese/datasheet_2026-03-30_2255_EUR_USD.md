...
> Généré le 30/03/2026 22:55 UTC | Prix : `1.146900` | ATR : `0.001307` (0.11%)
...
| Votes LONG / SHORT / HOLD | `28%` / `33%` / `40%` |
...
**Note comportementale** : _📊 Distribution équilibrée (28%L / 33%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
