...
> Généré le 30/03/2026 23:52 UTC | Prix : `66784.980000` | ATR : `445.527857` (0.67%)
...
| Votes LONG / SHORT / HOLD | `23%` / `46%` / `31%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (23%/46%). Prudence : la foule a souvent tort contre la structure._
