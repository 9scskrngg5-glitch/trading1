...
> Généré le 30/03/2026 23:59 UTC | Prix : `66784.980000` | ATR : `445.527857` (0.67%)
...
| Votes LONG / SHORT / HOLD | `22%` / `44%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (22%L / 44%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
