...
> Généré le 30/03/2026 20:00 UTC | Prix : `1.146700` | ATR : `0.001400` (0.12%)
...
| Votes LONG / SHORT / HOLD | `26%` / `36%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (26%L / 36%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
