...
> Généré le 31/03/2026 05:26 UTC | Prix : `2060.870000` | ATR : `22.034286` (1.07%)
...
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 2048.4537 |
...
#### Sentiment Global
> POSITIVE — score `+40.4` sur 5 signaux fondamentaux
...
#### Détection de Biais
> ⚠️  BIAIS SHORT DÉTECTÉ (70% des signaux) — Rechercher activement des setups LONG. Réduire la taille des positions SHORT de 20%.
...
| Votes LONG / SHORT / HOLD | `37%` / `29%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 29%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
