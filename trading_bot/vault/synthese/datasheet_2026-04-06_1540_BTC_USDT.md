...
> Généré le 06/04/2026 15:40 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
#### Sentiment Global
> POSITIVE — score `+30.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `51%` / `12%` / `36%` |
| Probabilité haussière | `66%` |
| Probabilité baissière | `16%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `30%` |

**Note comportementale** : _📊 Distribution équilibrée (51%L / 12%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
