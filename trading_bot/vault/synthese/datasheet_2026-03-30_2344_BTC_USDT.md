...
> Généré le 30/03/2026 23:44 UTC | Prix : `66784.980000` | ATR : `445.527857` (0.67%)
...
#### Sentiment Global
> POSITIVE — score `+38.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `22%` / `43%` / `36%` |
...
**Note comportementale** : _📊 Distribution équilibrée (22%L / 43%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
