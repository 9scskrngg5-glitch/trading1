...
> Généré le 31/03/2026 08:52 UTC | Prix : `2055.970000` | ATR : `19.916429` (0.97%)
...
| Votes LONG / SHORT / HOLD | `32%` / `37%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 37%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
