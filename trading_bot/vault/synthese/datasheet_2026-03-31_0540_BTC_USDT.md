...
> Généré le 31/03/2026 05:40 UTC | Prix : `67544.010000` | ATR : `514.870714` (0.76%)
...
| Votes LONG / SHORT / HOLD | `31%` / `33%` / `37%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 33%S / 37%H). Pas de consensus clair — marché indécis selon le crowd._
