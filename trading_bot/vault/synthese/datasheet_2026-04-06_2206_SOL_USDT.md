...
> Généré le 06/04/2026 22:06 UTC | Prix : `81.490000` | ATR : `0.612143` (0.75%)
...
#### Sentiment Global
> POSITIVE — score `+23.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `43%` / `28%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (43%L / 28%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
