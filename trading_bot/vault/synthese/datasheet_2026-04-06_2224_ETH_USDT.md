...
> Généré le 06/04/2026 22:24 UTC | Prix : `2139.540000` | ATR : `16.438571` (0.77%)
...
#### Sentiment Global
> NEUTRAL — score `+20.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `43%` / `26%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (43%L / 26%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
