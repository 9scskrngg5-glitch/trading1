...
> Généré le 31/03/2026 08:32 UTC | Prix : `67367.690000` | ATR : `475.960000` (0.71%)
...
| Votes LONG / SHORT / HOLD | `44%` / `29%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (44%L / 29%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
