...
> Généré le 30/03/2026 21:36 UTC | Prix : `66651.400000` | ATR : `447.366429` (0.67%)
...
| Votes LONG / SHORT / HOLD | `35%` / `39%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (35%L / 39%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
