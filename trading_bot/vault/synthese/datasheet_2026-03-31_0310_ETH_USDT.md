...
> Généré le 31/03/2026 03:10 UTC | Prix : `2073.090000` | ATR : `24.092857` (1.16%)
...
| Votes LONG / SHORT / HOLD | `37%` / `32%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 32%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
