...
> Généré le 31/03/2026 09:32 UTC | Prix : `66778.330000` | ATR : `503.559286` (0.75%)
...
| Votes LONG / SHORT / HOLD | `31%` / `39%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 39%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
