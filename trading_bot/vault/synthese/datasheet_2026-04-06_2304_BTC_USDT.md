...
> Généré le 06/04/2026 23:04 UTC | Prix : `68811.000000` | ATR : `476.138571` (0.69%)
...
| Votes LONG / SHORT / HOLD | `45%` / `31%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (45%L / 31%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
