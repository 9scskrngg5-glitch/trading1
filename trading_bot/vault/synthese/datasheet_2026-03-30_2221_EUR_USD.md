...
> Généré le 30/03/2026 22:21 UTC | Prix : `1.146900` | ATR : `0.001329` (0.12%)
...
| Votes LONG / SHORT / HOLD | `26%` / `42%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (26%L / 42%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
