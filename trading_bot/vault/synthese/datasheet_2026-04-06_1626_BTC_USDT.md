...
> Généré le 06/04/2026 16:26 UTC | Prix : `69968.870000` | ATR : `405.074286` (0.58%)
...
| Votes LONG / SHORT / HOLD | `43%` / `28%` / `29%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (43%/28%). Prudence : la foule a souvent tort contre la structure._
