...
> Généré le 06/04/2026 22:19 UTC | Prix : `2138.670000` | ATR : `15.745000` (0.74%)
...
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 2134.9268 |
...
| Votes LONG / SHORT / HOLD | `32%` / `20%` / `48%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 20%S / 48%H). Pas de consensus clair — marché indécis selon le crowd._
