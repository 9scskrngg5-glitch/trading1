...
> Généré le 31/03/2026 05:38 UTC | Prix : `83.340000` | ATR : `0.871429` (1.05%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.95% |
| Type | **RANGING** | volatilité medium |
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 83.3258 |
...
#### Sentiment Global
> NEGATIVE — score `-30.1` sur 4 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `26%` / `42%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (26%L / 42%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
