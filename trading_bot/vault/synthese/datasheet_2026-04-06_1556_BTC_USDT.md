...
> Généré le 06/04/2026 15:56 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
| Votes LONG / SHORT / HOLD | `53%` / `18%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (53%L / 18%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
