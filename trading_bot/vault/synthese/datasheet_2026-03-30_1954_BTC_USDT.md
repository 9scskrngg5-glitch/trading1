...
> Généré le 30/03/2026 19:54 UTC | Prix : `66653.460000` | ATR : `452.100000` (0.68%)
...
| Votes LONG / SHORT / HOLD | `33%` / `35%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 35%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
