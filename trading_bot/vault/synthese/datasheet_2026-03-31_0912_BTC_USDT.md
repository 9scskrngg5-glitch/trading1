...
> Généré le 31/03/2026 09:12 UTC | Prix : `66778.330000` | ATR : `503.559286` (0.75%)
...
| Votes LONG / SHORT / HOLD | `35%` / `34%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (35%L / 34%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
