...
> Généré le 06/04/2026 14:44 UTC | Prix : `82.460000` | ATR : `0.682857` (0.83%)
...
#### Sentiment Global
> NEGATIVE — score `-27.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `31%` / `28%` / `40%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (31%/28%). Prudence : la foule a souvent tort contre la structure._
