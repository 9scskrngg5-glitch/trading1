...
> Généré le 31/03/2026 07:09 UTC | Prix : `83.410000` | ATR : `0.882143` (1.06%)
...
| Votes LONG / SHORT / HOLD | `32%` / `30%` / `37%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 30%S / 37%H). Pas de consensus clair — marché indécis selon le crowd._
