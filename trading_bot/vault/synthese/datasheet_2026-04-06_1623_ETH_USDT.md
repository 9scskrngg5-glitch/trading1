...
> Généré le 06/04/2026 16:23 UTC | Prix : `2164.650000` | ATR : `16.298571` (0.75%)
...
|---|---|---|
| Direction | **BULLISH** | slope 20p = +4.63% |
| Type | **TRENDING** | volatilité low |
| Phase (Wyckoff) | **MARKUP** | EMA20 = 2128.0260 |
| Volatilité ATR% | `0.75%` | 🟢 Faible |
| Force de tendance | `46/100` | |
...
| POC (Point of Control) | `2052.21075` |
| Value Area High (VAH) | `2137.392` |
...
- 🧱 Fake wall potentiel côté ASK — OB imbalance -0.48 mais prix monte

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> POSITIVE — score `+44.1` sur 5 signaux fondamentaux
...
|---|---|---|
| Technique | `bullish` | `52/100` |
| Fondamental | `bullish` | `38/100` |
| Régime | `bullish` | — |
| Structure | `bullish` | — |
...
#### 📊 Intraday (1h–4h)
**Direction** : `LONG`
**Entrée** : Pull-back vers 2156.500714 ou OB bullish
**SL** : `2148.351429` | **TP** : `2197.247143` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
**SL** : `2132.052857` | **TP** : `2246.142857` | **R:R** : `1:2.5`
**Timeframe** : `1d–1W`
...
| Votes LONG / SHORT / HOLD | `44%` / `20%` / `35%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (44%/20%). Prudence : la foule a souvent tort contre la structure._
