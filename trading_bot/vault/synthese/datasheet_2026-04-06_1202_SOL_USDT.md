...
> Généré le 06/04/2026 12:02 UTC | Prix : `82.450000` | ATR : `0.857857` (1.04%)
...
- 🧱 Fake wall potentiel côté ASK — OB imbalance -0.42 mais prix monte
...
| Votes LONG / SHORT / HOLD | `33%` / `31%` / `37%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (33%/31%). Prudence : la foule a souvent tort contre la structure._
