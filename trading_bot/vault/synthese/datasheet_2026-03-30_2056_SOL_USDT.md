...
> Généré le 30/03/2026 20:56 UTC | Prix : `82.810000` | ATR : `0.810000` (0.98%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = +0.12% |
| Type | **RANGING** | volatilité medium |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 83.3672 |
...
| Votes LONG / SHORT / HOLD | `34%` / `33%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 33%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
