...
> Généré le 31/03/2026 09:43 UTC | Prix : `66778.330000` | ATR : `503.559286` (0.75%)
...
| Votes LONG / SHORT / HOLD | `32%` / `38%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 38%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
