...
> Généré le 31/03/2026 01:12 UTC | Prix : `1.148200` | ATR : `0.001386` (0.12%)
...
#### Sentiment Global
> POSITIVE — score `+26.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `30%` / `38%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (30%L / 38%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
