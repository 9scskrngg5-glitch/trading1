...
> Généré le 31/03/2026 10:27 UTC | Prix : `2018.370000` | ATR : `21.319286` (1.06%)
...
#### Sentiment Global
> NEGATIVE — score `-25.8` sur 5 signaux fondamentaux
...
#### Détection de Biais
> ✅ Équilibré : 45% long / 55% short sur 11 signaux
...
| Votes LONG / SHORT / HOLD | `27%` / `34%` / `40%` |
