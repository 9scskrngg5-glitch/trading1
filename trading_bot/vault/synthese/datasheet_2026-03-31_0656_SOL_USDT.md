...
> Généré le 31/03/2026 06:56 UTC | Prix : `83.770000` | ATR : `0.870714` (1.04%)
...
#### Détection de Biais
> ⚠️  BIAIS LONG DÉTECTÉ (89% des signaux) — Rechercher activement des setups SHORT. Réduire la taille des positions LONG de 20%.
...
| Votes LONG / SHORT / HOLD | `43%` / `33%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (43%L / 33%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
