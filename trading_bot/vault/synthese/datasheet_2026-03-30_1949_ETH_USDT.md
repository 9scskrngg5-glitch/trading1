...
> Généré le 30/03/2026 19:49 UTC | Prix : `2032.610000` | ATR : `19.312143` (0.95%)
...
#### Sentiment Global
> NEUTRAL — score `-13.1` sur 4 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `45%` / `36%` / `19%` |
...
**Note comportementale** : _📊 Distribution équilibrée (45%L / 36%S / 19%H). Pas de consensus clair — marché indécis selon le crowd._
