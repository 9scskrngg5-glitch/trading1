...
> Généré le 31/03/2026 04:07 UTC | Prix : `67704.740000` | ATR : `529.318571` (0.78%)
...
| Votes LONG / SHORT / HOLD | `34%` / `46%` / `20%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (34%/46%). Prudence : la foule a souvent tort contre la structure._
