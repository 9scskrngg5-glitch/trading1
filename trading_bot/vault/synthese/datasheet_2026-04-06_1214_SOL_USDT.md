...
> Généré le 06/04/2026 12:14 UTC | Prix : `82.450000` | ATR : `0.857857` (1.04%)
...
#### Sentiment Global
> POSITIVE — score `+34.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `35%` / `29%` / `36%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (35%/29%). Prudence : la foule a souvent tort contre la structure._
