...
> Généré le 31/03/2026 02:20 UTC | Prix : `2073.000000` | ATR : `23.675000` (1.14%)
...
| Votes LONG / SHORT / HOLD | `31%` / `45%` / `25%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 45%S / 25%H). Pas de consensus clair — marché indécis selon le crowd._
