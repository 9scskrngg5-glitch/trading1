...
> Généré le 31/03/2026 02:12 UTC | Prix : `67938.540000` | ATR : `555.844286` (0.82%)
...
| Votes LONG / SHORT / HOLD | `23%` / `43%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (23%L / 43%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
