...
> Généré le 31/03/2026 10:23 UTC | Prix : `2018.370000` | ATR : `21.319286` (1.06%)
...
| Votes LONG / SHORT / HOLD | `30%` / `28%` / `42%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 30% LONG avec support structurel. Consensus comportemental renforce l'analyse primaire._
