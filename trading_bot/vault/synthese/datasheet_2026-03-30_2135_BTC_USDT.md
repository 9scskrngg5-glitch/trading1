...
> Généré le 30/03/2026 21:35 UTC | Prix : `66651.400000` | ATR : `447.366429` (0.67%)
...
#### Sentiment Global
> NEUTRAL — score `-12.7` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `32%` / `41%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 41%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
