...
> Généré le 30/03/2026 23:33 UTC | Prix : `66784.980000` | ATR : `445.527857` (0.67%)
...
| Votes LONG / SHORT / HOLD | `25%` / `42%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (25%L / 42%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
