...
> Généré le 30/03/2026 21:56 UTC | Prix : `66651.400000` | ATR : `447.366429` (0.67%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.00% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 67104.2978 |
...
#### Sentiment Global
> NEUTRAL — score `-14.1` sur 3 signaux fondamentaux
