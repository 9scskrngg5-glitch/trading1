...
> Généré le 06/04/2026 13:50 UTC | Prix : `69366.750000` | ATR : `431.429286` (0.62%)
...
| Votes LONG / SHORT / HOLD | `52%` / `13%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (52%L / 13%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
