...
> Généré le 30/03/2026 21:36 UTC | Prix : `2023.200000` | ATR : `19.407143` (0.96%)
...
| Votes LONG / SHORT / HOLD | `36%` / `39%` / `25%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 39%S / 25%H). Pas de consensus clair — marché indécis selon le crowd._
