...
> Généré le 31/03/2026 06:53 UTC | Prix : `83.770000` | ATR : `0.870714` (1.04%)
...
#### Détection de Biais
> ⚠️  BIAIS LONG DÉTECTÉ (88% des signaux) — Rechercher activement des setups SHORT. Réduire la taille des positions LONG de 20%.
...
| Votes LONG / SHORT / HOLD | `42%` / `34%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 34%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
