...
> Généré le 31/03/2026 03:02 UTC | Prix : `67943.430000` | ATR : `556.410714` (0.82%)
...
| Votes LONG / SHORT / HOLD | `38%` / `32%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (38%L / 32%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
