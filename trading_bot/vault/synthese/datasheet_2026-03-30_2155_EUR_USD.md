...
> Généré le 30/03/2026 21:55 UTC | Prix : `1.147000` | ATR : `0.001329` (0.12%)
...
| Votes LONG / SHORT / HOLD | `24%` / `37%` / `39%` |
...
**Note comportementale** : _📊 Distribution équilibrée (24%L / 37%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
