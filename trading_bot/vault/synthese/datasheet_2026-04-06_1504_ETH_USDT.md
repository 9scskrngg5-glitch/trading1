...
> Généré le 06/04/2026 15:04 UTC | Prix : `2156.710000` | ATR : `16.152143` (0.75%)
...
#### Sentiment Global
> POSITIVE — score `+45.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `48%` / `22%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (48%L / 22%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
