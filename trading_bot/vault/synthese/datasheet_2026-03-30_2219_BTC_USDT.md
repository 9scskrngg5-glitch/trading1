...
> Généré le 30/03/2026 22:19 UTC | Prix : `66809.760000` | ATR : `444.197857` (0.67%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.54% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 67050.8685 |
...
| Votes LONG / SHORT / HOLD | `33%` / `40%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 40%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
