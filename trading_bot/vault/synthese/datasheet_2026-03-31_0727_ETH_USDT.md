...
> Généré le 31/03/2026 07:27 UTC | Prix : `2062.330000` | ATR : `21.315000` (1.03%)
...
| Votes LONG / SHORT / HOLD | `40%` / `33%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 33%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
