...
> Généré le 30/03/2026 22:53 UTC | Prix : `1.146900` | ATR : `0.001329` (0.12%)
...
| Votes LONG / SHORT / HOLD | `27%` / `37%` / `36%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 37%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
