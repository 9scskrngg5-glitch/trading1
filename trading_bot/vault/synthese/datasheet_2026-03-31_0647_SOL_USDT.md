...
> Généré le 31/03/2026 06:47 UTC | Prix : `83.770000` | ATR : `0.870714` (1.04%)
...
#### Sentiment Global
> POSITIVE — score `+36.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `43%` / `33%` / `23%` |
...
**Note comportementale** : _📊 Distribution équilibrée (43%L / 33%S / 23%H). Pas de consensus clair — marché indécis selon le crowd._
