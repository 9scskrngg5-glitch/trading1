...
> Généré le 30/03/2026 21:41 UTC | Prix : `66651.400000` | ATR : `447.366429` (0.67%)
...
| Votes LONG / SHORT / HOLD | `30%` / `44%` / `25%` |
...
**Note comportementale** : _📊 Distribution équilibrée (30%L / 44%S / 25%H). Pas de consensus clair — marché indécis selon le crowd._
