...
> Généré le 30/03/2026 20:59 UTC | Prix : `82.390000` | ATR : `0.804286` (0.98%)
...
| Votes LONG / SHORT / HOLD | `42%` / `38%` / `20%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 38%S / 20%H). Pas de consensus clair — marché indécis selon le crowd._
