...
> Généré le 31/03/2026 02:17 UTC | Prix : `83.850000` | ATR : `0.927857` (1.11%)
...
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 83.2391 |
...
#### Sentiment Global
> POSITIVE — score `+23.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `30%` / `37%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (30%L / 37%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
