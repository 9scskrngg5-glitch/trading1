...
> Généré le 31/03/2026 02:34 UTC | Prix : `83.850000` | ATR : `0.927857` (1.11%)
...
| Votes LONG / SHORT / HOLD | `27%` / `40%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 40%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
