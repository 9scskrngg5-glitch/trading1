...
> Généré le 30/03/2026 21:35 UTC | Prix : `82.790000` | ATR : `0.810000` (0.98%)
...
#### Sentiment Global
> POSITIVE — score `+25.7` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `21%` / `28%` / `51%` |
...
**Note comportementale** : _📊 Distribution équilibrée (21%L / 28%S / 51%H). Pas de consensus clair — marché indécis selon le crowd._
