...
> Généré le 06/04/2026 21:24 UTC | Prix : `2148.810000` | ATR : `16.945000` (0.79%)
...
| Votes LONG / SHORT / HOLD | `52%` / `17%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (52%L / 17%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
