...
> Généré le 06/04/2026 04:34 UTC | Prix : `69123.690000` | ATR : `454.348571` (0.66%)
...
#### Sentiment Global
> NEUTRAL — score `-10.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `47%` / `25%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (47%L / 25%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
