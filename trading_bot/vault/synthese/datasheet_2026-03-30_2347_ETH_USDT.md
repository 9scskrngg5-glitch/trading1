...
> Généré le 30/03/2026 23:47 UTC | Prix : `2033.080000` | ATR : `19.340000` (0.95%)
...
| Votes LONG / SHORT / HOLD | `27%` / `34%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 34%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
