...
> Généré le 31/03/2026 04:58 UTC | Prix : `67704.740000` | ATR : `529.318571` (0.78%)
...
| Votes LONG / SHORT / HOLD | `35%` / `40%` / `25%` |
...
**Note comportementale** : _📊 Distribution équilibrée (35%L / 40%S / 25%H). Pas de consensus clair — marché indécis selon le crowd._
