...
> Généré le 31/03/2026 08:34 UTC | Prix : `83.100000` | ATR : `0.840714` (1.01%)
...
| Votes LONG / SHORT / HOLD | `22%` / `45%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (22%L / 45%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
