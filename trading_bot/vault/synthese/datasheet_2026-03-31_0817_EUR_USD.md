...
> Généré le 31/03/2026 08:17 UTC | Prix : `1.147800` | ATR : `0.001057` (0.09%)
...
#### Sentiment Global
> NEGATIVE — score `-42.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `25%` / `52%` / `22%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (25%/52%). Prudence : la foule a souvent tort contre la structure._
