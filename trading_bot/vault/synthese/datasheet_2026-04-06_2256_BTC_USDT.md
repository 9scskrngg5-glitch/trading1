...
> Généré le 06/04/2026 22:56 UTC | Prix : `69504.990000` | ATR : `440.070714` (0.63%)
...
#### Sentiment Global
> POSITIVE — score `+29.0` sur 5 signaux fondamentaux
...
#### Détection de Biais
> ✅ Équilibré : 37% long / 63% short sur 30 signaux
...
| Votes LONG / SHORT / HOLD | `50%` / `28%` / `22%` |
