...
> Généré le 31/03/2026 02:18 UTC | Prix : `67938.540000` | ATR : `555.844286` (0.82%)
...
| Votes LONG / SHORT / HOLD | `22%` / `44%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (22%L / 44%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
