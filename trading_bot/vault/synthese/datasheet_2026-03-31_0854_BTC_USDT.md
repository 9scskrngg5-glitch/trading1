...
> Généré le 31/03/2026 08:54 UTC | Prix : `67367.690000` | ATR : `475.960000` (0.71%)
...
#### Sentiment Global
> POSITIVE — score `+30.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `45%` / `27%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (45%L / 27%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
