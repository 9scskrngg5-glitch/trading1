...
> Généré le 30/03/2026 21:43 UTC | Prix : `83.510000` | ATR : `0.815000` (0.98%)
...
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 83.3789 |
...
| Votes LONG / SHORT / HOLD | `34%` / `40%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 40%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
