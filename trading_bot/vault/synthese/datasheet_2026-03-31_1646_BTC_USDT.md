...
> Généré le 31/03/2026 16:46 UTC | Prix : `67663.190000` | ATR : `672.631429` (0.99%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = +1.28% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **TRANSITION** | EMA20 = 67043.0083 |
...
| Votes LONG / SHORT / HOLD | `43%` / `37%` / `20%` |
...
**Note comportementale** : _📊 Distribution équilibrée (43%L / 37%S / 20%H). Pas de consensus clair — marché indécis selon le crowd._
