...
> Généré le 06/04/2026 22:04 UTC | Prix : `2139.540000` | ATR : `16.438571` (0.77%)
...
| Votes LONG / SHORT / HOLD | `42%` / `29%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 29%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
