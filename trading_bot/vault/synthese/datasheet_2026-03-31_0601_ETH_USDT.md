...
> Généré le 31/03/2026 06:01 UTC | Prix : `2064.310000` | ATR : `21.764286` (1.05%)
...
| Votes LONG / SHORT / HOLD | `38%` / `32%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (38%L / 32%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
