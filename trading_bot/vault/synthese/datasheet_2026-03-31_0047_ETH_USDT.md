...
> Généré le 31/03/2026 00:47 UTC | Prix : `2026.480000` | ATR : `20.047143` (0.99%)
...
| Votes LONG / SHORT / HOLD | `34%` / `42%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 42%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
