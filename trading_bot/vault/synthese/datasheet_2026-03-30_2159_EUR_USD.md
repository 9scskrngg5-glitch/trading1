...
> Généré le 30/03/2026 21:59 UTC | Prix : `1.146900` | ATR : `0.001379` (0.12%)
...
#### Sentiment Global
> NEUTRAL — score `+12.9` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `36%` / `41%` / `23%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 41%S / 23%H). Pas de consensus clair — marché indécis selon le crowd._
