...
> Généré le 31/03/2026 05:21 UTC | Prix : `67544.010000` | ATR : `514.870714` (0.76%)
...
| Votes LONG / SHORT / HOLD | `29%` / `34%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 34%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
