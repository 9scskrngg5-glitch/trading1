...
> Généré le 06/04/2026 16:03 UTC | Prix : `69968.870000` | ATR : `405.074286` (0.58%)
...
#### Sentiment Global
> NEUTRAL — score `-14.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `43%` / `27%` / `30%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (43%/27%). Prudence : la foule a souvent tort contre la structure._
