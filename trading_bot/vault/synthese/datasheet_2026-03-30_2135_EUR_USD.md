...
> Généré le 30/03/2026 21:35 UTC | Prix : `1.146900` | ATR : `0.001379` (0.12%)
...
#### Sentiment Global
> NEUTRAL — score `+17.8` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `32%` / `32%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 32%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
