...
> Généré le 06/04/2026 23:00 UTC | Prix : `68811.000000` | ATR : `476.138571` (0.69%)
...
| Votes LONG / SHORT / HOLD | `44%` / `32%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (44%L / 32%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
