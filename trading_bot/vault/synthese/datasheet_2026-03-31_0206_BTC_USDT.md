...
> Généré le 31/03/2026 02:06 UTC | Prix : `67938.540000` | ATR : `555.844286` (0.82%)
...
#### Sentiment Global
> POSITIVE — score `+34.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `24%` / `41%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (24%L / 41%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
