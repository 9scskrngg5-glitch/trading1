...
> Généré le 06/04/2026 13:43 UTC | Prix : `2143.590000` | ATR : `18.072143` (0.84%)
...
| Votes LONG / SHORT / HOLD | `50%` / `21%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (50%L / 21%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
