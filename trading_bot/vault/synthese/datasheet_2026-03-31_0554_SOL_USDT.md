...
> Généré le 31/03/2026 05:54 UTC | Prix : `83.340000` | ATR : `0.871429` (1.05%)
...
| Votes LONG / SHORT / HOLD | `26%` / `41%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (26%L / 41%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
