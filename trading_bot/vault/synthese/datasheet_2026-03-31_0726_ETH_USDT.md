...
> Généré le 31/03/2026 07:26 UTC | Prix : `2062.330000` | ATR : `21.315000` (1.03%)
...
| Votes LONG / SHORT / HOLD | `42%` / `32%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 32%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
