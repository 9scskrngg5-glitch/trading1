...
> Généré le 06/04/2026 10:58 UTC | Prix : `82.110000` | ATR : `0.831429` (1.01%)
...
| Votes LONG / SHORT / HOLD | `27%` / `37%` / `35%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (27%/37%). Prudence : la foule a souvent tort contre la structure._
