...
> Généré le 06/04/2026 13:20 UTC | Prix : `69366.750000` | ATR : `431.429286` (0.62%)
...
#### Sentiment Global
> NEUTRAL — score `-10.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `52%` / `14%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (52%L / 14%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
