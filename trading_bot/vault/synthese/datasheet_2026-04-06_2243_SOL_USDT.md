...
> Généré le 06/04/2026 22:43 UTC | Prix : `81.490000` | ATR : `0.612143` (0.75%)
...
| Votes LONG / SHORT / HOLD | `42%` / `24%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 24%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
