...
> Généré le 31/03/2026 04:59 UTC | Prix : `2066.710000` | ATR : `23.229286` (1.12%)
...
| Votes LONG / SHORT / HOLD | `31%` / `35%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 35%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
