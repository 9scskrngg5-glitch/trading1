...
> Généré le 06/04/2026 14:07 UTC | Prix : `69428.230000` | ATR : `391.775000` (0.56%)
...
#### Sentiment Global
> NEGATIVE — score `-22.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `40%` / `17%` / `43%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (40%/17%). Prudence : la foule a souvent tort contre la structure._
