...
> Généré le 31/03/2026 04:36 UTC | Prix : `2066.710000` | ATR : `23.229286` (1.12%)
...
| Votes LONG / SHORT / HOLD | `30%` / `34%` / `36%` |
...
**Note comportementale** : _📊 Distribution équilibrée (30%L / 34%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
