...
> Généré le 06/04/2026 21:13 UTC | Prix : `69713.860000` | ATR : `421.045000` (0.60%)
...
| Phase (Wyckoff) | **TRANSITION** | EMA20 = 69374.9873 |
| Volatilité ATR% | `0.60%` | 🟢 Faible |
...
| Votes LONG / SHORT / HOLD | `46%` / `34%` / `20%` |
