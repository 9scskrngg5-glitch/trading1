...
> Généré le 30/03/2026 23:32 UTC | Prix : `66784.980000` | ATR : `445.527857` (0.67%)
...
#### Sentiment Global
> NEUTRAL — score `-4.6` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `24%` / `42%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (24%L / 42%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
