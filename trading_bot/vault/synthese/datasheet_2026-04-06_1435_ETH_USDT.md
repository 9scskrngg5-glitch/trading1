...
> Généré le 06/04/2026 14:35 UTC | Prix : `2145.990000` | ATR : `15.955000` (0.74%)
...
#### Sentiment Global
> POSITIVE — score `+46.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `45%` / `22%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (45%L / 22%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
