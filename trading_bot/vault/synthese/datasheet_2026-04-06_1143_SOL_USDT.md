...
> Généré le 06/04/2026 11:43 UTC | Prix : `82.460000` | ATR : `0.852857` (1.03%)
...
|---|---|---|
| Direction | **BULLISH** | slope 20p = +3.77% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **MARKUP** | EMA20 = 81.5513 |
...
#### ⚡ Scalping (5m–15m)
**Direction** : `LONG`
**Entrée** : 82.460000 (niveau courant)
**SL** : `82.118857` | **TP** : `83.142286` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
**SL** : `83.311143` | **TP** : `82.287714` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
#### 📊 Intraday (1h–4h)
**Direction** : `LONG`
**Entrée** : Pull-back vers 82.033571 ou OB bullish
**SL** : `81.607143` | **TP** : `84.165714` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
**SL** : `80.754286` | **TP** : `86.724286` | **R:R** : `1:2.5`
**Timeframe** : `1d–1W`
...
| Votes LONG / SHORT / HOLD | `35%` / `25%` / `40%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (35%/25%). Prudence : la foule a souvent tort contre la structure._
