...
> Généré le 31/03/2026 06:11 UTC | Prix : `67681.680000` | ATR : `507.090714` (0.75%)
...
#### Sentiment Global
> POSITIVE — score `+35.1` sur 5 signaux fondamentaux
...
#### Détection de Biais
> ⚠️  BIAIS LONG DÉTECTÉ (81% des signaux) — Rechercher activement des setups SHORT. Réduire la taille des positions LONG de 20%.
...
| Votes LONG / SHORT / HOLD | `32%` / `29%` / `39%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 29%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
