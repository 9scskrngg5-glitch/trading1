...
> Généré le 31/03/2026 08:44 UTC | Prix : `1.147800` | ATR : `0.001057` (0.09%)
...
#### Sentiment Global
> NEGATIVE — score `-26.2` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `30%` / `51%` / `20%` |
