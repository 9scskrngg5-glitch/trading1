...
> Généré le 06/04/2026 21:33 UTC | Prix : `2148.810000` | ATR : `16.945000` (0.79%)
...
| Votes LONG / SHORT / HOLD | `48%` / `21%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (48%L / 21%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
