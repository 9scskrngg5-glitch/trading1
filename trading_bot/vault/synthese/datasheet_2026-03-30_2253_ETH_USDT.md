...
> Généré le 30/03/2026 22:53 UTC | Prix : `2036.000000` | ATR : `19.492857` (0.96%)
...
#### Sentiment Global
> POSITIVE — score `+44.2` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `37%` / `36%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 36%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
