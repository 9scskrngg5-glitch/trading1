...
> Généré le 30/03/2026 23:55 UTC | Prix : `66784.980000` | ATR : `445.527857` (0.67%)
...
#### Sentiment Global
> NEUTRAL — score `-17.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `20%` / `47%` / `34%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (20%/47%). Prudence : la foule a souvent tort contre la structure._
