...
> Généré le 06/04/2026 21:25 UTC | Prix : `2148.810000` | ATR : `16.945000` (0.79%)
...
| Votes LONG / SHORT / HOLD | `47%` / `22%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (47%L / 22%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
