...
> Généré le 31/03/2026 04:43 UTC | Prix : `2066.710000` | ATR : `23.229286` (1.12%)
...
| Votes LONG / SHORT / HOLD | `37%` / `26%` / `37%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 26%S / 37%H). Pas de consensus clair — marché indécis selon le crowd._
