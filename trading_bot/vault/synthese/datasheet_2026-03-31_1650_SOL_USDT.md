...
> Généré le 31/03/2026 16:50 UTC | Prix : `80.860000` | ATR : `1.014286` (1.25%)
...
|---|---|---|
| Direction | **BEARISH** | slope 20p = -2.33% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **MARKDOWN** | EMA20 = 82.0548 |
| Volatilité ATR% | `1.25%` | 🟡 Moyenne |
...
| Indicateur | Valeur |
|---|---|
| Volatilité réalisée (VIX) | `12.0%` — 🟢 Faible (<30%) |
| Percentile session | `76e percentile` |
| POC (Point of Control) | `80.77375` |
| Value Area High (VAH) | `83.5075` |
| Value Area Low (VAL) | `80.47` |
| HVN (High Vol. Nodes) | `80.5713` | `80.7738` | `83.4062` |
| LVN (Low Vol. Nodes) | `81.3812` | `81.5837` | `83.0012` |
...
|---|---|
| **Swing Lows récents** | `78.9600` | `81.9600` | `82.1400` | `80.0800` |
...
| Niveau | Prix | Force | Validations |
|---|---|---|---|
| S1 | `80.080000` | `25/100` | `1` touches |
| S2 | `78.960000` | `25/100` | `1` touches |
...
#### Sentiment Global
> NEGATIVE — score `-27.0` sur 5 signaux fondamentaux
...
#### ⚡ Scalping (5m–15m)
**Direction** : `SHORT`
**Entrée** : 80.860000 (niveau courant)
**SL** : `81.265714` | **TP** : `80.048571` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
#### ⚡ Scalping Contrarian
**Direction** : `LONG`
**Entrée** : 80.08 (support S1)
**SL** : `79.674286` | **TP** : `80.891429` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
#### 📊 Intraday (1h–4h)
**Direction** : `SHORT`
**Entrée** : Rebond vers 81.367143 ou OB bearish
**SL** : `81.874286` | **TP** : `78.831429` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
| Votes LONG / SHORT / HOLD | `33%` / `46%` / `21%` |
| Probabilité haussière | `44%` |
| Probabilité baissière | `46%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `1%` |

**Note comportementale** : _📊 Distribution équilibrée (33%L / 46%S / 21%H). Pas de consensus clair — marché indécis selon le crowd._
