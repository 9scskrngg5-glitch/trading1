...
> Généré le 30/03/2026 22:21 UTC | Prix : `83.150000` | ATR : `0.815000` (0.98%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.24% |
| Type | **RANGING** | volatilité medium |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 83.3446 |
...
|---|---|
| **Swing Lows récents** | `81.6900` | `81.1200` | `78.9600` |
...
| Votes LONG / SHORT / HOLD | `15%` / `33%` / `52%` |
...
**Note comportementale** : _📊 Distribution équilibrée (15%L / 33%S / 52%H). Pas de consensus clair — marché indécis selon le crowd._
