...
> Généré le 31/03/2026 08:54 UTC | Prix : `83.100000` | ATR : `0.840714` (1.01%)
...
| Votes LONG / SHORT / HOLD | `23%` / `45%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (23%L / 45%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
