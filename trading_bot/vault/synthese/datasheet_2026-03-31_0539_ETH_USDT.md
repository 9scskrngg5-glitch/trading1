...
> Généré le 31/03/2026 05:39 UTC | Prix : `2060.870000` | ATR : `22.034286` (1.07%)
...
| Votes LONG / SHORT / HOLD | `32%` / `27%` / `41%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 27%S / 41%H). Pas de consensus clair — marché indécis selon le crowd._
