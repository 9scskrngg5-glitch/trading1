...
> Généré le 31/03/2026 01:28 UTC | Prix : `67208.750000` | ATR : `498.372857` (0.74%)
...
| Votes LONG / SHORT / HOLD | `24%` / `44%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (24%L / 44%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
