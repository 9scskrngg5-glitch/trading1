...
> Généré le 30/03/2026 20:56 UTC | Prix : `1.146800` | ATR : `0.001379` (0.12%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.36% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 1.1483 |
...
| Votes LONG / SHORT / HOLD | `42%` / `46%` / `12%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (42%/46%). Prudence : la foule a souvent tort contre la structure._
