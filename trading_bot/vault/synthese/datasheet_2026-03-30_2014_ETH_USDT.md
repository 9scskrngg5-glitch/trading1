...
> Généré le 30/03/2026 20:14 UTC | Prix : `2023.700000` | ATR : `19.705000` (0.97%)
...
| Votes LONG / SHORT / HOLD | `40%` / `44%` / `16%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 44%S / 16%H). Pas de consensus clair — marché indécis selon le crowd._
