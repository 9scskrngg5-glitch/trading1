...
> Généré le 30/03/2026 19:56 UTC | Prix : `82.690000` | ATR : `0.802143` (0.97%)
...
#### Sentiment Global
> NEGATIVE — score `-23.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `34%` / `39%` / `28%` |
