...
> Généré le 31/03/2026 00:55 UTC | Prix : `2026.480000` | ATR : `20.047143` (0.99%)
...
| Votes LONG / SHORT / HOLD | `28%` / `43%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (28%L / 43%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
