...
> Généré le 31/03/2026 08:24 UTC | Prix : `2055.970000` | ATR : `19.916429` (0.97%)
...
| Votes LONG / SHORT / HOLD | `36%` / `36%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 36%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
