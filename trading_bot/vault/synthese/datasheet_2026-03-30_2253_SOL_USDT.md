...
> Généré le 30/03/2026 22:53 UTC | Prix : `83.150000` | ATR : `0.815000` (0.98%)
...
#### Sentiment Global
> NEUTRAL — score `-15.6` sur 4 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `36%` / `37%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 37%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
