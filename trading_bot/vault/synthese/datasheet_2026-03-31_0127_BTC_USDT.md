...
> Généré le 31/03/2026 01:27 UTC | Prix : `67208.750000` | ATR : `498.372857` (0.74%)
...
| Votes LONG / SHORT / HOLD | `25%` / `43%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (25%L / 43%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
