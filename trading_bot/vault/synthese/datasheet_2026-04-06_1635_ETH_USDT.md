...
> Généré le 06/04/2026 16:35 UTC | Prix : `2164.650000` | ATR : `16.298571` (0.75%)
...
#### Sentiment Global
> NEUTRAL — score `+12.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `47%` / `26%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (47%L / 26%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
