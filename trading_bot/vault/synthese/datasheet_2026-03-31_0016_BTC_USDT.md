...
> Généré le 31/03/2026 00:16 UTC | Prix : `66797.370000` | ATR : `455.454286` (0.68%)
...
#### Sentiment Global
> POSITIVE — score `+23.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `17%` / `41%` / `42%` |
...
**Note comportementale** : _📊 Distribution équilibrée (17%L / 41%S / 42%H). Pas de consensus clair — marché indécis selon le crowd._
