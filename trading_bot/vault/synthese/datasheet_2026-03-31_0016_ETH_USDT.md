...
> Généré le 31/03/2026 00:16 UTC | Prix : `2026.480000` | ATR : `20.047143` (0.99%)
...
#### Sentiment Global
> POSITIVE — score `+25.6` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `31%` / `48%` / `21%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (31%/48%). Prudence : la foule a souvent tort contre la structure._
