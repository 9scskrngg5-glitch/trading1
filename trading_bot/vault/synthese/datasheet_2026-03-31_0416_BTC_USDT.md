...
> Généré le 31/03/2026 04:16 UTC | Prix : `67704.740000` | ATR : `529.318571` (0.78%)
...
#### Sentiment Global
> POSITIVE — score `+37.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `37%` / `39%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 39%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
