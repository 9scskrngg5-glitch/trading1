...
> Généré le 06/04/2026 15:16 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
|---|---|---|
| Direction | **BULLISH** | slope 20p = +3.40% |
| Type | **TRENDING** | volatilité low |
| Phase (Wyckoff) | **MARKUP** | EMA20 = 68962.4300 |
| Volatilité ATR% | `0.57%` | 🟢 Faible |
...
| HVN (High Vol. Nodes) | `66858.2625` | `67306.3575` | `69098.7375` |
| LVN (Low Vol. Nodes) | — |
...
- 🧱 Fake wall potentiel côté BID — OB imbalance +0.64 mais prix baisse

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> POSITIVE — score `+35.0` sur 5 signaux fondamentaux
...
|---|---|---|
| Technique | `bullish` | `63/100` |
| Fondamental | `bullish` | `53/100` |
| Régime | `bullish` | — |
| Structure | `bullish` | — |
...
#### 📊 Intraday (1h–4h)
**Direction** : `LONG`
**Entrée** : Pull-back vers 69455.195714 ou OB bullish
**SL** : `69256.011429` | **TP** : `70451.117143` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
**SL** : `68857.642857` | **TP** : `71646.222857` | **R:R** : `1:2.5`
**Timeframe** : `1d–1W`
...
| Votes LONG / SHORT / HOLD | `55%` / `11%` / `34%` |
| Probabilité haussière | `69%` |
| Probabilité baissière | `14%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `34%` |

**Note comportementale** : _📊 Distribution équilibrée (55%L / 11%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
