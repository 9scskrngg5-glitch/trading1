...
> Généré le 06/04/2026 16:22 UTC | Prix : `2164.650000` | ATR : `16.298571` (0.75%)
...
| Votes LONG / SHORT / HOLD | `50%` / `23%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (50%L / 23%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
