...
> Généré le 31/03/2026 07:24 UTC | Prix : `67492.850000` | ATR : `504.093571` (0.75%)
...
#### Sentiment Global
> NEUTRAL — score `-19.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `36%` / `44%` / `20%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 44%S / 20%H). Pas de consensus clair — marché indécis selon le crowd._
