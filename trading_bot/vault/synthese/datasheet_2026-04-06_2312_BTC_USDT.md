...
> Généré le 06/04/2026 23:12 UTC | Prix : `68811.000000` | ATR : `476.138571` (0.69%)
...
#### Sentiment Global
> POSITIVE — score `+24.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `45%` / `33%` / `22%` |
