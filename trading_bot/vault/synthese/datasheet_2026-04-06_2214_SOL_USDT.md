...
> Généré le 06/04/2026 22:14 UTC | Prix : `81.490000` | ATR : `0.612143` (0.75%)
...
#### Sentiment Global
> NEUTRAL — score `-15.3` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `41%` / `32%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (41%L / 32%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
