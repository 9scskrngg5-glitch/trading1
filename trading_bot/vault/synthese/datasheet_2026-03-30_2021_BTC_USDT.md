...
> Généré le 30/03/2026 20:21 UTC | Prix : `66550.050000` | ATR : `457.345714` (0.69%)
...
| Votes LONG / SHORT / HOLD | `19%` / `43%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (19%L / 43%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
