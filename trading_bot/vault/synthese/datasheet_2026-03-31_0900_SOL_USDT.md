...
> Généré le 31/03/2026 09:00 UTC | Prix : `82.250000` | ATR : `0.850000` (1.03%)
...
#### Sentiment Global
> NEUTRAL — score `+6.2` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `14%` / `31%` / `55%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 31% SHORT avec support structurel. Consensus comportemental renforce l'analyse primaire._
