...
> Généré le 31/03/2026 06:21 UTC | Prix : `67681.680000` | ATR : `507.090714` (0.75%)
...
| Votes LONG / SHORT / HOLD | `33%` / `29%` / `39%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 29%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
