...
> Généré le 31/03/2026 05:10 UTC | Prix : `2060.870000` | ATR : `22.034286` (1.07%)
...
| Votes LONG / SHORT / HOLD | `38%` / `36%` / `25%` |
...
**Note comportementale** : _📊 Distribution équilibrée (38%L / 36%S / 25%H). Pas de consensus clair — marché indécis selon le crowd._
