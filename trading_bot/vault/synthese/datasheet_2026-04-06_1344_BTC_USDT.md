...
> Généré le 06/04/2026 13:44 UTC | Prix : `69366.750000` | ATR : `431.429286` (0.62%)
...
| Votes LONG / SHORT / HOLD | `52%` / `14%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (52%L / 14%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
