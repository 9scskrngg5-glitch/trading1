...
> Généré le 31/03/2026 06:41 UTC | Prix : `1.147200` | ATR : `0.001050` (0.09%)
...
#### Sentiment Global
> POSITIVE — score `+29.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `32%` / `50%` / `19%` |
| Probabilité haussière | `39%` |
| Probabilité baissière | `51%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `-25` (-50 à +50) |
| Risque manipulation crowd | `2%` |

**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (32%/50%). Prudence : la foule a souvent tort contre la structure._
