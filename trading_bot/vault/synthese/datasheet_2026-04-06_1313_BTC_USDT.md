...
> Généré le 06/04/2026 13:13 UTC | Prix : `69366.750000` | ATR : `431.429286` (0.62%)
...
|---|---|---|
| Direction | **BULLISH** | slope 20p = +2.96% |
| Type | **TRENDING** | volatilité low |
| Phase (Wyckoff) | **MARKUP** | EMA20 = 68832.9522 |
| Volatilité ATR% | `0.62%` | 🟢 Faible |
...
| S2 | `66866.971667` | `100/100` | `6` touches |
...
- 🧱 Fake wall potentiel côté ASK — OB imbalance -0.44 mais prix monte

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> NEUTRAL — score `-6.4` sur 5 signaux fondamentaux
...
#### 📊 Intraday (1h–4h)
**Direction** : `LONG`
**Entrée** : Pull-back vers 69151.035357 ou OB bullish
**SL** : `68935.320714` | **TP** : `70229.608571` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
**SL** : `68503.891429` | **TP** : `71523.896429` | **R:R** : `1:2.5`
**Timeframe** : `1d–1W`
...
| Votes LONG / SHORT / HOLD | `50%` / `16%` / `34%` |
| Probabilité haussière | `65%` |
| Probabilité baissière | `18%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `6%` |

**Note comportementale** : _📊 Distribution équilibrée (50%L / 16%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
