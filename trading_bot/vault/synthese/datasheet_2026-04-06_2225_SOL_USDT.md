...
> Généré le 06/04/2026 22:25 UTC | Prix : `81.490000` | ATR : `0.612143` (0.75%)
...
| Votes LONG / SHORT / HOLD | `39%` / `27%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (39%L / 27%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
