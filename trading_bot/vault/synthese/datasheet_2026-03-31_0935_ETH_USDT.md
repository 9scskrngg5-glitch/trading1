...
> Généré le 31/03/2026 09:35 UTC | Prix : `2040.100000` | ATR : `20.423571` (1.00%)
...
#### Sentiment Global
> NEUTRAL — score `+4.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `35%` / `33%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (35%L / 33%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
