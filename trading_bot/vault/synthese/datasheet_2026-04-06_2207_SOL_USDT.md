...
> Généré le 06/04/2026 22:07 UTC | Prix : `81.490000` | ATR : `0.612143` (0.75%)
...
| Votes LONG / SHORT / HOLD | `44%` / `24%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (44%L / 24%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
