...
> Généré le 31/03/2026 16:50 UTC | Prix : `1.152400` | ATR : `0.001614` (0.14%)
...
| Votes LONG / SHORT / HOLD | `44%` / `24%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (44%L / 24%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
