...
> Généré le 31/03/2026 00:54 UTC | Prix : `2026.480000` | ATR : `20.047143` (0.99%)
...
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 2039.0748 |
...
| Indicateur | Valeur |
|---|---|
| Volatilité réalisée (VIX) | `9.5%` — 🟢 Faible (<30%) |
...
#### Sentiment Global
> NEGATIVE — score `-23.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `30%` / `49%` / `21%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (30%/49%). Prudence : la foule a souvent tort contre la structure._
