...
> Généré le 06/04/2026 22:44 UTC | Prix : `2139.540000` | ATR : `16.438571` (0.77%)
...
#### Détection de Biais
> ✅ Équilibré : 55% long / 45% short sur 22 signaux
...
| Votes LONG / SHORT / HOLD | `42%` / `28%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 28%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
