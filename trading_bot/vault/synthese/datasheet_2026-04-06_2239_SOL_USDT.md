...
> Généré le 06/04/2026 22:39 UTC | Prix : `81.490000` | ATR : `0.612143` (0.75%)
...
#### Sentiment Global
> POSITIVE — score `+39.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `41%` / `24%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (41%L / 24%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
