...
> Généré le 06/04/2026 15:22 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
| Votes LONG / SHORT / HOLD | `51%` / `13%` / `36%` |
| Probabilité haussière | `68%` |
| Probabilité baissière | `14%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `8%` |

**Note comportementale** : _📊 Distribution équilibrée (51%L / 13%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
