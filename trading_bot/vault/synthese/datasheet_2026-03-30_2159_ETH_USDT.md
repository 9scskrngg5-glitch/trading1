...
> Généré le 30/03/2026 21:59 UTC | Prix : `2023.200000` | ATR : `19.407143` (0.96%)
...
#### Sentiment Global
> POSITIVE — score `+31.5` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `31%` / `36%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 36%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
