...
> Généré le 31/03/2026 09:56 UTC | Prix : `2040.100000` | ATR : `20.423571` (1.00%)
...
| Votes LONG / SHORT / HOLD | `38%` / `31%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (38%L / 31%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
