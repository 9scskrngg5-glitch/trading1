...
> Généré le 06/04/2026 10:52 UTC | Prix : `82.110000` | ATR : `0.831429` (1.01%)
...
| Votes LONG / SHORT / HOLD | `32%` / `34%` / `35%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (32%/34%). Prudence : la foule a souvent tort contre la structure._
