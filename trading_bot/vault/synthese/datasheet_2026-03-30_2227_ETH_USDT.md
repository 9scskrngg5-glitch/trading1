...
> Généré le 30/03/2026 22:27 UTC | Prix : `2036.000000` | ATR : `19.492857` (0.96%)
...
#### Sentiment Global
> POSITIVE — score `+31.7` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `33%` / `44%` / `23%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 44%S / 23%H). Pas de consensus clair — marché indécis selon le crowd._
