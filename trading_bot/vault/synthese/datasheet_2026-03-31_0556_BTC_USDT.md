...
> Généré le 31/03/2026 05:56 UTC | Prix : `67544.010000` | ATR : `514.870714` (0.76%)
...
#### Détection de Biais
> ⚠️  BIAIS LONG DÉTECTÉ (69% des signaux) — Rechercher activement des setups SHORT. Réduire la taille des positions LONG de 20%.
...
| Votes LONG / SHORT / HOLD | `31%` / `32%` / `37%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 32%S / 37%H). Pas de consensus clair — marché indécis selon le crowd._
