...
> Généré le 30/03/2026 23:30 UTC | Prix : `2024.140000` | ATR : `20.047143` (0.99%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -1.18% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 2038.8520 |
...
| Votes LONG / SHORT / HOLD | `44%` / `33%` / `23%` |
...
**Note comportementale** : _📊 Distribution équilibrée (44%L / 33%S / 23%H). Pas de consensus clair — marché indécis selon le crowd._
