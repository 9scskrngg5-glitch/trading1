...
> Généré le 30/03/2026 21:28 UTC | Prix : `82.790000` | ATR : `0.810000` (0.98%)
...
| Votes LONG / SHORT / HOLD | `42%` / `36%` / `22%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 36%S / 22%H). Pas de consensus clair — marché indécis selon le crowd._
