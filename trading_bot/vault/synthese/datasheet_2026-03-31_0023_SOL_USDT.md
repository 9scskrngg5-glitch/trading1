...
> Généré le 31/03/2026 00:23 UTC | Prix : `82.540000` | ATR : `0.832143` (1.01%)
...
| Votes LONG / SHORT / HOLD | `38%` / `44%` / `18%` |
...
**Note comportementale** : _📊 Distribution équilibrée (38%L / 44%S / 18%H). Pas de consensus clair — marché indécis selon le crowd._
