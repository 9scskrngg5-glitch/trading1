...
> Généré le 31/03/2026 00:31 UTC | Prix : `66797.370000` | ATR : `455.454286` (0.68%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -1.21% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 67024.9250 |
...
#### Sentiment Global
> NEGATIVE — score `-24.5` sur 5 signaux fondamentaux
...
#### ⚡ Scalping (5m–15m)
**Direction** : `RANGE`
**Entrée** : LONG @ 66272.697500 | SHORT @ 67104.362500
...
| Votes LONG / SHORT / HOLD | `15%` / `42%` / `43%` |
| Probabilité haussière | `38%` |
| Probabilité baissière | `40%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `8%` |

**Note comportementale** : _📊 Distribution équilibrée (15%L / 42%S / 43%H). Pas de consensus clair — marché indécis selon le crowd._
