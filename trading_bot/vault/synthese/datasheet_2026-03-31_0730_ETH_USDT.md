...
> Généré le 31/03/2026 07:30 UTC | Prix : `2062.330000` | ATR : `21.315000` (1.03%)
...
| Votes LONG / SHORT / HOLD | `39%` / `25%` / `36%` |
...
**Note comportementale** : _📊 Distribution équilibrée (39%L / 25%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
