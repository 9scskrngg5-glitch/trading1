...
> Généré le 30/03/2026 19:59 UTC | Prix : `66653.460000` | ATR : `452.100000` (0.68%)
...
| Votes LONG / SHORT / HOLD | `28%` / `44%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (28%L / 44%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
