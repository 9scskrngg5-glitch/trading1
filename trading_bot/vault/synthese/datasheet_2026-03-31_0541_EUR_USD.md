...
> Généré le 31/03/2026 05:41 UTC | Prix : `1.147800` | ATR : `0.001150` (0.10%)
...
#### Détection de Biais
> ⚠️  BIAIS SHORT DÉTECTÉ (78% des signaux) — Rechercher activement des setups LONG. Réduire la taille des positions SHORT de 20%.
...
| Votes LONG / SHORT / HOLD | `30%` / `50%` / `20%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (30%/50%). Prudence : la foule a souvent tort contre la structure._
