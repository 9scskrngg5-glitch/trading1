...
> Généré le 31/03/2026 03:26 UTC | Prix : `83.830000` | ATR : `0.927143` (1.11%)
...
#### Sentiment Global
> NEUTRAL — score `-15.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `31%` / `41%` / `28%` |
| Probabilité haussière | `44%` |
| Probabilité baissière | `42%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `0%` |

**Note comportementale** : _📊 Distribution équilibrée (31%L / 41%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
