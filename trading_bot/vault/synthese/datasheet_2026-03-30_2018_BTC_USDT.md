...
> Généré le 30/03/2026 20:18 UTC | Prix : `66550.050000` | ATR : `457.345714` (0.69%)
...
- 🧱 Fake wall potentiel côté BID — OB imbalance +0.54 mais prix baisse
...
| Votes LONG / SHORT / HOLD | `20%` / `41%` / `39%` |
...
**Note comportementale** : _📊 Distribution équilibrée (20%L / 41%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
