...
> Généré le 31/03/2026 06:53 UTC | Prix : `2064.310000` | ATR : `21.764286` (1.05%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = +0.32% |
| Type | **RANGING** | volatilité medium |
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 2049.9662 |
| Volatilité ATR% | `1.05%` | 🟡 Moyenne |
...
#### Sentiment Global
> NEUTRAL — score `-16.9` sur 5 signaux fondamentaux
...
#### Détection de Biais
> ⚠️  BIAIS SHORT DÉTECTÉ (80% des signaux) — Rechercher activement des setups LONG. Réduire la taille des positions SHORT de 20%.
...
| Votes LONG / SHORT / HOLD | `38%` / `32%` / `30%` |
| Probabilité haussière | `57%` |
| Probabilité baissière | `28%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `18%` |

**Note comportementale** : _📊 Distribution équilibrée (38%L / 32%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
