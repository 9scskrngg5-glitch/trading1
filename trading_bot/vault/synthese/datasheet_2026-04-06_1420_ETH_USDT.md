...
> Généré le 06/04/2026 14:20 UTC | Prix : `2145.990000` | ATR : `15.955000` (0.74%)
...
| Votes LONG / SHORT / HOLD | `46%` / `21%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (46%L / 21%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
