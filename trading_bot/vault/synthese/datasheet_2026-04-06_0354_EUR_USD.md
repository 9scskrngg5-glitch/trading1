...
> Généré le 06/04/2026 03:54 UTC | Prix : `1.152100` | ATR : `0.000643` (0.06%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = +0.05% |
...
**Note comportementale** : _📊 Distribution équilibrée (30%L / 28%S / 42%H). Pas de consensus clair — marché indécis selon le crowd._
