...
> Généré le 31/03/2026 00:12 UTC | Prix : `82.540000` | ATR : `0.832143` (1.01%)
...
| Votes LONG / SHORT / HOLD | `36%` / `45%` / `18%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (36%/45%). Prudence : la foule a souvent tort contre la structure._
