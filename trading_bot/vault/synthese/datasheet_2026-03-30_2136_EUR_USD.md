...
> Généré le 30/03/2026 21:36 UTC | Prix : `1.146900` | ATR : `0.001379` (0.12%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.35% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 1.1484 |
...
| Votes LONG / SHORT / HOLD | `32%` / `31%` / `37%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 31%S / 37%H). Pas de consensus clair — marché indécis selon le crowd._
