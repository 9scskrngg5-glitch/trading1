...
> Généré le 31/03/2026 08:15 UTC | Prix : `83.100000` | ATR : `0.840714` (1.01%)
...
#### Sentiment Global
> NEUTRAL — score `-18.3` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `25%` / `43%` / `33%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 43% SHORT avec support structurel. Consensus comportemental renforce l'analyse primaire._
