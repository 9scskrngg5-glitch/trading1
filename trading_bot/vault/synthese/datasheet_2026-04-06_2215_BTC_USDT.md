...
> Généré le 06/04/2026 22:15 UTC | Prix : `69504.990000` | ATR : `440.070714` (0.63%)
...
| Votes LONG / SHORT / HOLD | `45%` / `26%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (45%L / 26%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
