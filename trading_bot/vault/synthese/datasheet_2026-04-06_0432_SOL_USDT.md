...
> Généré le 06/04/2026 04:32 UTC | Prix : `81.890000` | ATR : `0.845714` (1.03%)
...
|---|---|---|
| Direction | **BULLISH** | slope 20p = +2.57% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **MARKUP** | EMA20 = 80.8960 |
...
| Indicateur | Valeur |
|---|---|
| Volatilité réalisée (VIX) | `8.2%` — 🟢 Faible (<30%) |
...
#### ⚡ Scalping (5m–15m)
**Direction** : `LONG`
**Entrée** : 81.890000 (niveau courant)
**SL** : `81.551714` | **TP** : `82.566571` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
**SL** : `83.308286` | **TP** : `82.293429` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
#### 📊 Intraday (1h–4h)
**Direction** : `LONG`
**Entrée** : Pull-back vers 81.467143 ou OB bullish
**SL** : `81.044286` | **TP** : `83.581429` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
| Votes LONG / SHORT / HOLD | `36%` / `38%` / `26%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (36%/38%). Prudence : la foule a souvent tort contre la structure._
