...
> Généré le 31/03/2026 00:41 UTC | Prix : `1.146500` | ATR : `0.001257` (0.11%)
...
| Votes LONG / SHORT / HOLD | `31%` / `38%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 38%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
