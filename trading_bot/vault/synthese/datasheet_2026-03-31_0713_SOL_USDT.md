...
> Généré le 31/03/2026 07:13 UTC | Prix : `83.410000` | ATR : `0.882143` (1.06%)
...
#### Sentiment Global
> NEUTRAL — score `-6.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `32%` / `33%` / `36%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 33%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
