...
> Généré le 31/03/2026 06:04 UTC | Prix : `2064.310000` | ATR : `21.764286` (1.05%)
...
| Votes LONG / SHORT / HOLD | `36%` / `34%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 34%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
