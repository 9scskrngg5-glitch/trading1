...
> Généré le 30/03/2026 19:55 UTC | Prix : `66653.460000` | ATR : `452.100000` (0.68%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = +0.97% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **TRANSITION** | EMA20 = 67216.0414 |
| Volatilité ATR% | `0.68%` | 🟢 Faible |
...
| Niveau | Prix | Force | Validations |
|---|---|---|---|
| S1 | `66245.515000` | `100/100` | `4` touches |
...
| SSL (Sell-Side) | `66202.9` | Stops de vendeurs — cible de stop-hunt |
...
#### Sentiment Global
> NEUTRAL — score `-15.8` sur 5 signaux fondamentaux
...
#### ⚡ Scalping (5m–15m)
**Direction** : `RANGE`
**Entrée** : LONG @ 66245.515000 | SHORT @ 67042.256000
...
| Votes LONG / SHORT / HOLD | `29%` / `43%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 43%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
