...
> Généré le 06/04/2026 16:12 UTC | Prix : `2164.650000` | ATR : `16.298571` (0.75%)
...
- 🧱 Fake wall potentiel côté ASK — OB imbalance -0.62 mais prix monte

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> POSITIVE — score `+36.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `45%` / `24%` / `31%` |
| Probabilité haussière | `60%` |
| Probabilité baissière | `24%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `-25` (-50 à +50) |
| Risque manipulation crowd | `21%` |

**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (45%/24%). Prudence : la foule a souvent tort contre la structure._
