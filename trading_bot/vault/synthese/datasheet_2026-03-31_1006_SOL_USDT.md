...
> Généré le 31/03/2026 10:06 UTC | Prix : `80.550000` | ATR : `0.967857` (1.20%)
...
#### Sentiment Global
> NEGATIVE — score `-28.8` sur 5 signaux fondamentaux
...
#### ⚡ Scalping (5m–15m)
**Direction** : `SHORT`
**Entrée** : 80.550000 (niveau courant)
**SL** : `80.937143` | **TP** : `79.775714` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
**SL** : `78.572857` | **TP** : `79.734286` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
| Votes LONG / SHORT / HOLD | `32%` / `42%` / `26%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 42% SHORT avec support structurel. Consensus comportemental renforce l'analyse primaire._
