...
> Généré le 06/04/2026 10:40 UTC | Prix : `69123.690000` | ATR : `454.348571` (0.66%)
...
#### Sentiment Global
> NEUTRAL — score `-14.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `47%` / `27%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (47%L / 27%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
