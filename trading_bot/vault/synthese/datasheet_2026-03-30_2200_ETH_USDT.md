...
> Généré le 30/03/2026 22:00 UTC | Prix : `2035.580000` | ATR : `18.355714` (0.90%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.01% |
| Type | **RANGING** | volatilité medium |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 2040.6332 |
...
| Votes LONG / SHORT / HOLD | `39%` / `46%` / `15%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (39%/46%). Prudence : la foule a souvent tort contre la structure._
