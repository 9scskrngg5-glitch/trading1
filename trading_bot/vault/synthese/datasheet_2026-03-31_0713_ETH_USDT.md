...
> Généré le 31/03/2026 07:13 UTC | Prix : `2062.330000` | ATR : `21.315000` (1.03%)
...
| Votes LONG / SHORT / HOLD | `38%` / `26%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (38%L / 26%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
