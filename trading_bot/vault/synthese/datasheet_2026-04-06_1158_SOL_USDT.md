...
> Généré le 06/04/2026 11:58 UTC | Prix : `82.680000` | ATR : `0.880000` (1.06%)
...
| Votes LONG / SHORT / HOLD | `39%` / `38%` / `23%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (39%/38%). Prudence : la foule a souvent tort contre la structure._
