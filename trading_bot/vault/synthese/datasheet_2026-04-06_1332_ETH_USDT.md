...
> Généré le 06/04/2026 13:32 UTC | Prix : `2143.590000` | ATR : `18.072143` (0.84%)
...
#### Sentiment Global
> NEUTRAL — score `-10.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `50%` / `20%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (50%L / 20%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
