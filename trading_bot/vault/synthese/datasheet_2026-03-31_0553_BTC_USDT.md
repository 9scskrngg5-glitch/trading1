...
> Généré le 31/03/2026 05:53 UTC | Prix : `67544.010000` | ATR : `514.870714` (0.76%)
...
#### Détection de Biais
> ✅ Équilibré : 62% long / 38% short sur 13 signaux
...
| Votes LONG / SHORT / HOLD | `37%` / `37%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 37%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
