...
> Généré le 30/03/2026 21:40 UTC | Prix : `1.146900` | ATR : `0.001379` (0.12%)
...
#### Sentiment Global
> POSITIVE — score `+22.5` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `31%` / `43%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 43%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
