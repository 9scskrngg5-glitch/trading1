...
> Généré le 31/03/2026 10:39 UTC | Prix : `80.550000` | ATR : `0.967857` (1.20%)
...
| Votes LONG / SHORT / HOLD | `22%` / `47%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (22%L / 47%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
