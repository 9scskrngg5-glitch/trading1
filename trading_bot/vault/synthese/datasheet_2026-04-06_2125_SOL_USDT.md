...
> Généré le 06/04/2026 21:25 UTC | Prix : `82.000000` | ATR : `0.612143` (0.75%)
...
#### Détection de Biais
> ⚠️  BIAIS LONG DÉTECTÉ (91% des signaux) — Rechercher activement des setups SHORT. Réduire la taille des positions LONG de 20%.
...
| Votes LONG / SHORT / HOLD | `29%` / `36%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 36%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
