...
> Généré le 31/03/2026 01:42 UTC | Prix : `2036.650000` | ATR : `21.089286` (1.03%)
...
| Votes LONG / SHORT / HOLD | `19%` / `21%` / `60%` |
...
**Note comportementale** : _📊 Distribution équilibrée (19%L / 21%S / 60%H). Pas de consensus clair — marché indécis selon le crowd._
