...
> Généré le 31/03/2026 01:55 UTC | Prix : `82.720000` | ATR : `0.842857` (1.02%)
...
#### Sentiment Global
> POSITIVE — score `+28.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `36%` / `49%` / `15%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (36%/49%). Prudence : la foule a souvent tort contre la structure._
