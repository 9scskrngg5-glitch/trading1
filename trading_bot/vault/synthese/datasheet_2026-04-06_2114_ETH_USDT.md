...
> Généré le 06/04/2026 21:14 UTC | Prix : `2148.810000` | ATR : `16.945000` (0.79%)
...
#### ⚡ Scalping (5m–15m)
**Direction** : `LONG`
**Entrée** : 2148.810000 (niveau courant)
**SL** : `2142.032` | **TP** : `2162.366` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
#### ⚡ Scalping Contrarian
**Direction** : `SHORT`
**Entrée** : 2172.195 (résistance R1)
**SL** : `2178.973` | **TP** : `2158.639` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
| Votes LONG / SHORT / HOLD | `51%` / `17%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (51%L / 17%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
