...
> Généré le 31/03/2026 03:43 UTC | Prix : `2073.090000` | ATR : `24.092857` (1.16%)
...
| Votes LONG / SHORT / HOLD | `40%` / `36%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 36%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
