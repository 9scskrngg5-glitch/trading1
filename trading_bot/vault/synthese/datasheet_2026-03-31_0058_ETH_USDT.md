...
> Généré le 31/03/2026 00:58 UTC | Prix : `2026.480000` | ATR : `20.047143` (0.99%)
...
#### Sentiment Global
> POSITIVE — score `+29.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `32%` / `47%` / `21%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (32%/47%). Prudence : la foule a souvent tort contre la structure._
