...
> Généré le 31/03/2026 01:49 UTC | Prix : `2036.650000` | ATR : `21.089286` (1.03%)
...
| Votes LONG / SHORT / HOLD | `20%` / `21%` / `59%` |
...
**Note comportementale** : _📊 Distribution équilibrée (20%L / 21%S / 59%H). Pas de consensus clair — marché indécis selon le crowd._
