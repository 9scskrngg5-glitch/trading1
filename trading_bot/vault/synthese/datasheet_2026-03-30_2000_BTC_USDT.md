...
> Généré le 30/03/2026 20:00 UTC | Prix : `66550.050000` | ATR : `457.345714` (0.69%)
...
| Votes LONG / SHORT / HOLD | `19%` / `44%` / `37%` |
| Probabilité haussière | `35%` |
| Probabilité baissière | `46%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `19%` |

**Note comportementale** : _📊 Distribution équilibrée (19%L / 44%S / 37%H). Pas de consensus clair — marché indécis selon le crowd._
