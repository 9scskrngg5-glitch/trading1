...
> Généré le 31/03/2026 02:50 UTC | Prix : `83.850000` | ATR : `0.927857` (1.11%)
...
#### Sentiment Global
> POSITIVE — score `+35.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `31%` / `37%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 37%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
