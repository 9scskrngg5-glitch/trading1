...
> Généré le 31/03/2026 09:27 UTC | Prix : `2040.100000` | ATR : `20.423571` (1.00%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -1.01% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 2050.4774 |
| Volatilité ATR% | `1.00%` | 🟡 Moyenne |
...
| Votes LONG / SHORT / HOLD | `37%` / `31%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 31%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
