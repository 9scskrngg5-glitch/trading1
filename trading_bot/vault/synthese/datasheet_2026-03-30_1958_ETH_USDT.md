...
> Généré le 30/03/2026 19:58 UTC | Prix : `2032.610000` | ATR : `19.312143` (0.95%)
...
| Votes LONG / SHORT / HOLD | `45%` / `34%` / `20%` |
...
**Note comportementale** : _📊 Distribution équilibrée (45%L / 34%S / 20%H). Pas de consensus clair — marché indécis selon le crowd._
