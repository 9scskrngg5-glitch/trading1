...
> Généré le 31/03/2026 10:40 UTC | Prix : `1.147500` | ATR : `0.001079` (0.09%)
...
| Votes LONG / SHORT / HOLD | `30%` / `31%` / `39%` |
...
**Note comportementale** : _📊 Distribution équilibrée (30%L / 31%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
