...
> Généré le 31/03/2026 06:52 UTC | Prix : `2064.310000` | ATR : `21.764286` (1.05%)
...
| Votes LONG / SHORT / HOLD | `36%` / `34%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 34%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
