...
> Généré le 31/03/2026 07:50 UTC | Prix : `1.148100` | ATR : `0.001064` (0.09%)
...
#### Sentiment Global
> NEUTRAL — score `+0.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `31%` / `50%` / `20%` |
