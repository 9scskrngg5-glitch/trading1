...
> Généré le 31/03/2026 04:20 UTC | Prix : `1.147900` | ATR : `0.001214` (0.11%)
...
#### Sentiment Global
> NEGATIVE — score `-28.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `30%` / `37%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (30%L / 37%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
