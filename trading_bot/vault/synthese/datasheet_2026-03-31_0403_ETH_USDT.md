...
> Généré le 31/03/2026 04:03 UTC | Prix : `2066.710000` | ATR : `23.229286` (1.12%)
...
| Votes LONG / SHORT / HOLD | `28%` / `34%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (28%L / 34%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
