...
> Généré le 31/03/2026 02:46 UTC | Prix : `67938.540000` | ATR : `555.844286` (0.82%)
...
| Votes LONG / SHORT / HOLD | `25%` / `41%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (25%L / 41%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
