...
> Généré le 31/03/2026 04:22 UTC | Prix : `83.600000` | ATR : `0.897143` (1.07%)
...
| Votes LONG / SHORT / HOLD | `44%` / `33%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (44%L / 33%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
