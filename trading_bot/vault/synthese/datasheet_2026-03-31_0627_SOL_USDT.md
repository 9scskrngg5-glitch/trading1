...
> Généré le 31/03/2026 06:27 UTC | Prix : `83.770000` | ATR : `0.870714` (1.04%)
...
| Votes LONG / SHORT / HOLD | `41%` / `35%` / `23%` |
...
**Note comportementale** : _📊 Distribution équilibrée (41%L / 35%S / 23%H). Pas de consensus clair — marché indécis selon le crowd._
