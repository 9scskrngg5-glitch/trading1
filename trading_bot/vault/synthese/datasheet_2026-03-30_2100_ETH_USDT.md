...
> Généré le 30/03/2026 21:00 UTC | Prix : `2023.200000` | ATR : `19.407143` (0.96%)
...
| Votes LONG / SHORT / HOLD | `26%` / `24%` / `50%` |
...
**Note comportementale** : _📊 Distribution équilibrée (26%L / 24%S / 50%H). Pas de consensus clair — marché indécis selon le crowd._
