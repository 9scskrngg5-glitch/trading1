...
> Généré le 06/04/2026 10:48 UTC | Prix : `69123.690000` | ATR : `454.348571` (0.66%)
...
#### Sentiment Global
> POSITIVE — score `+53.2` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `53%` / `22%` / `25%` |
...
**Note comportementale** : _📊 Distribution équilibrée (53%L / 22%S / 25%H). Pas de consensus clair — marché indécis selon le crowd._
