...
> Généré le 31/03/2026 00:26 UTC | Prix : `66797.370000` | ATR : `455.454286` (0.68%)
...
| Votes LONG / SHORT / HOLD | `22%` / `33%` / `45%` |
...
**Note comportementale** : _📊 Distribution équilibrée (22%L / 33%S / 45%H). Pas de consensus clair — marché indécis selon le crowd._
