...
> Généré le 31/03/2026 08:27 UTC | Prix : `83.100000` | ATR : `0.840714` (1.01%)
...
| Votes LONG / SHORT / HOLD | `20%` / `47%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (20%L / 47%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
