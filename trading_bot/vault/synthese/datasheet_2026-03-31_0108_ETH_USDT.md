...
> Généré le 31/03/2026 01:08 UTC | Prix : `2036.650000` | ATR : `21.089286` (1.03%)
...
| Votes LONG / SHORT / HOLD | `21%` / `19%` / `60%` |
...
**Note comportementale** : _📊 Distribution équilibrée (21%L / 19%S / 60%H). Pas de consensus clair — marché indécis selon le crowd._
