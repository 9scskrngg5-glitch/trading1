...
> Généré le 31/03/2026 05:17 UTC | Prix : `83.340000` | ATR : `0.871429` (1.05%)
...
| Votes LONG / SHORT / HOLD | `37%` / `33%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 33%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
