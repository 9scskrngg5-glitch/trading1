...
> Généré le 06/04/2026 22:33 UTC | Prix : `69504.990000` | ATR : `440.070714` (0.63%)
...
#### Sentiment Global
> NEGATIVE — score `-41.4` sur 5 signaux fondamentaux
...
#### Détection de Biais
> ✅ Équilibré : 42% long / 58% short sur 12 signaux
...
| Votes LONG / SHORT / HOLD | `45%` / `32%` / `23%` |
...
**Note comportementale** : _📊 Distribution équilibrée (45%L / 32%S / 23%H). Pas de consensus clair — marché indécis selon le crowd._
