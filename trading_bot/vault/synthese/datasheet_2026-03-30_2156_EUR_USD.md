...
> Généré le 30/03/2026 21:56 UTC | Prix : `1.146900` | ATR : `0.001379` (0.12%)
...
#### Sentiment Global
> POSITIVE — score `+20.7` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `23%` / `38%` / `39%` |
...
**Note comportementale** : _📊 Distribution équilibrée (23%L / 38%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
