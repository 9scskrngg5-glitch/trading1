...
> Généré le 31/03/2026 08:15 UTC | Prix : `67367.690000` | ATR : `475.960000` (0.71%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.78% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 67339.1150 |
| Volatilité ATR% | `0.71%` | 🟢 Faible |
...
#### Sentiment Global
> POSITIVE — score `+26.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `45%` / `26%` / `28%` |
