...
> Généré le 31/03/2026 07:01 UTC | Prix : `1.148100` | ATR : `0.001064` (0.09%)
...
#### Sentiment Global
> NEGATIVE — score `-46.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `25%` / `53%` / `22%` |
| Probabilité haussière | `40%` |
| Probabilité baissière | `49%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `-25` (-50 à +50) |
| Risque manipulation crowd | `11%` |

**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (25%/53%). Prudence : la foule a souvent tort contre la structure._
