...
> Généré le 30/03/2026 20:55 UTC | Prix : `2023.700000` | ATR : `19.705000` (0.97%)
...
| Votes LONG / SHORT / HOLD | `39%` / `36%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (39%L / 36%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
