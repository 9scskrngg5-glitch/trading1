...
> Généré le 30/03/2026 22:01 UTC | Prix : `66809.300000` | ATR : `448.105000` (0.67%)
...
#### Sentiment Global
> NEUTRAL — score `-16.5` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `19%` / `35%` / `46%` |
...
**Note comportementale** : _📊 Distribution équilibrée (19%L / 35%S / 46%H). Pas de consensus clair — marché indécis selon le crowd._
