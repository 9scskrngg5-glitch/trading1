...
> Généré le 31/03/2026 10:22 UTC | Prix : `1.147500` | ATR : `0.001079` (0.09%)
...
#### Détection de Biais
> ⚠️  BIAIS SHORT DÉTECTÉ (79% des signaux) — Rechercher activement des setups LONG. Réduire la taille des positions SHORT de 20%.
...
| Votes LONG / SHORT / HOLD | `33%` / `32%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 32%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
