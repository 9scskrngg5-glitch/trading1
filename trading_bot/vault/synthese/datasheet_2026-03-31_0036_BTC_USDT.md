...
> Généré le 31/03/2026 00:36 UTC | Prix : `66797.370000` | ATR : `455.454286` (0.68%)
...
| Votes LONG / SHORT / HOLD | `20%` / `36%` / `44%` |
...
**Note comportementale** : _📊 Distribution équilibrée (20%L / 36%S / 44%H). Pas de consensus clair — marché indécis selon le crowd._
