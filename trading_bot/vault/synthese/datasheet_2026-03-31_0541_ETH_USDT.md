...
> Généré le 31/03/2026 05:41 UTC | Prix : `2060.870000` | ATR : `22.034286` (1.07%)
...
| Votes LONG / SHORT / HOLD | `36%` / `24%` / `40%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 24%S / 40%H). Pas de consensus clair — marché indécis selon le crowd._
