...
> Généré le 06/04/2026 23:17 UTC | Prix : `68811.000000` | ATR : `476.138571` (0.69%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.45% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 69303.2515 |
...
| Indicateur | Valeur |
|---|---|
| Volatilité réalisée (VIX) | `6.5%` — 🟢 Faible (<30%) |
...
- 🧱 Fake wall potentiel côté BID — OB imbalance +0.59 mais prix baisse
