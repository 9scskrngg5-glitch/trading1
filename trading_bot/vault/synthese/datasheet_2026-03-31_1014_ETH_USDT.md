...
> Généré le 31/03/2026 10:14 UTC | Prix : `2025.170000` | ATR : `21.415714` (1.06%)
...
|---|---|---|
| Direction | **BEARISH** | slope 20p = -2.38% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **MARKDOWN** | EMA20 = 2045.2633 |
...
| Indicateur | Valeur |
|---|---|
| Volatilité réalisée (VIX) | `10.2%` — 🟢 Faible (<30%) |
...
| R2 | `2049.100000` | `25/100` | `1` touches |
...
#### ⚡ Scalping (5m–15m)
**Direction** : `SHORT`
**Entrée** : 2025.170000 (niveau courant)
**SL** : `2033.736286` | **TP** : `2008.037429` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
**SL** : `2005.058714` | **TP** : `2030.757571` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
#### 📊 Intraday (1h–4h)
**Direction** : `SHORT`
**Entrée** : Rebond vers 2035.877857 ou OB bearish
**SL** : `2046.585714` | **TP** : `1982.338571` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
| Votes LONG / SHORT / HOLD | `42%` / `34%` / `25%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 42% LONG avec support structurel. Consensus comportemental renforce l'analyse primaire._
