...
> Généré le 30/03/2026 21:02 UTC | Prix : `1.147000` | ATR : `0.001257` (0.11%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.39% |
...
| Votes LONG / SHORT / HOLD | `25%` / `30%` / `45%` |
...
**Note comportementale** : _📊 Distribution équilibrée (25%L / 30%S / 45%H). Pas de consensus clair — marché indécis selon le crowd._
