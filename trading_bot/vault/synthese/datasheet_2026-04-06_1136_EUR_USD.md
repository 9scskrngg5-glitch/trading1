...
> Généré le 06/04/2026 11:36 UTC | Prix : `1.154900` | ATR : `0.000864` (0.07%)
...
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 1.1520 |
| Volatilité ATR% | `0.07%` | 🟢 Faible |
...
| Indicateur | Valeur |
|---|---|
| Volatilité réalisée (VIX) | `0.7%` — 🟢 Faible (<30%) |
| Percentile session | `100e percentile` |
| POC (Point of Control) | `1.1516` |
| Value Area High (VAH) | `1.1519` |
| Value Area Low (VAL) | `1.1513` |
| HVN (High Vol. Nodes) | `1.1514` | `1.1516` | `1.1518` |
| LVN (Low Vol. Nodes) | — |
...
> **🔴 Bearish (LH/LL)**
> 🔔 **BREAK OF STRUCTURE** détecté à `1.1523`
...
| Niveau | Prix | Force | Validations |
|---|---|---|---|
| S1 | `1.151359` | `100/100` | `17` touches |

#### Zones de Liquidité
| Type | Prix | Description |
|---|---|---|
| BSL (Buy-Side) | `—` | Stops d'acheteurs — cible de stop-hunt |
| SSL (Sell-Side) | `1.15145` | Stops de vendeurs — cible de stop-hunt |
...
- 🧱 Fake wall potentiel côté ASK — OB imbalance -0.41 mais prix monte

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> NEUTRAL — score `-17.7` sur 5 signaux fondamentaux
...
- 🔔 Break of Structure à 1.1523 — recalibrage recommandé
...
| Votes LONG / SHORT / HOLD | `34%` / `36%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 36%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
