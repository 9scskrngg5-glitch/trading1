...
> Généré le 30/03/2026 22:21 UTC | Prix : `2036.000000` | ATR : `19.492857` (0.96%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = +0.30% |
| Type | **RANGING** | volatilité medium |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 2041.1625 |
...
| Votes LONG / SHORT / HOLD | `33%` / `47%` / `20%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (33%/47%). Prudence : la foule a souvent tort contre la structure._
