...
> Généré le 31/03/2026 01:28 UTC | Prix : `1.148200` | ATR : `0.001386` (0.12%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.34% |
...
#### Sentiment Global
> NEGATIVE — score `-38.3` sur 5 signaux fondamentaux
...
#### Détection de Biais
> ⚠️  BIAIS SHORT DÉTECTÉ (77% des signaux) — Rechercher activement des setups LONG. Réduire la taille des positions SHORT de 20%.
...
| Votes LONG / SHORT / HOLD | `27%` / `38%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 38%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
