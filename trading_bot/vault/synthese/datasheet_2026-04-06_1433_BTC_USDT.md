...
> Généré le 06/04/2026 14:33 UTC | Prix : `69428.230000` | ATR : `391.775000` (0.56%)
...
#### Sentiment Global
> NEUTRAL — score `-6.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `41%` / `19%` / `40%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (41%/19%). Prudence : la foule a souvent tort contre la structure._
