...
> Généré le 06/04/2026 22:19 UTC | Prix : `81.400000` | ATR : `0.583571` (0.72%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.86% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 81.7434 |
| Volatilité ATR% | `0.72%` | 🟢 Faible |
...
| LVN (Low Vol. Nodes) | `79.0920` | `79.4600` | `80.1960` |
...
| Votes LONG / SHORT / HOLD | `32%` / `38%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 38%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
