...
> Généré le 31/03/2026 01:15 UTC | Prix : `2036.650000` | ATR : `21.089286` (1.03%)
...
| Votes LONG / SHORT / HOLD | `24%` / `18%` / `58%` |
...
**Note comportementale** : _📊 Distribution équilibrée (24%L / 18%S / 59%H). Pas de consensus clair — marché indécis selon le crowd._
