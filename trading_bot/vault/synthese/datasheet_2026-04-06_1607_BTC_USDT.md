...
> Généré le 06/04/2026 16:07 UTC | Prix : `69968.870000` | ATR : `405.074286` (0.58%)
...
| Votes LONG / SHORT / HOLD | `42%` / `28%` / `30%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (42%/28%). Prudence : la foule a souvent tort contre la structure._
