...
> Généré le 06/04/2026 15:38 UTC | Prix : `82.230000` | ATR : `0.682857` (0.83%)
...
| Votes LONG / SHORT / HOLD | `38%` / `29%` / `33%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (38%/29%). Prudence : la foule a souvent tort contre la structure._
