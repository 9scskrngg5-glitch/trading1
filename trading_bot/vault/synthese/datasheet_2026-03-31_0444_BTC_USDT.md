...
> Généré le 31/03/2026 04:44 UTC | Prix : `67704.740000` | ATR : `529.318571` (0.78%)
...
#### Sentiment Global
> NEGATIVE — score `-20.3` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `33%` / `48%` / `20%` |
