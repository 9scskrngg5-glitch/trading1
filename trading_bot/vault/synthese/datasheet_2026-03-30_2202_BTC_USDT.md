...
> Généré le 30/03/2026 22:02 UTC | Prix : `66809.300000` | ATR : `448.105000` (0.67%)
...
| Votes LONG / SHORT / HOLD | `18%` / `35%` / `47%` |
...
**Note comportementale** : _📊 Distribution équilibrée (18%L / 35%S / 47%H). Pas de consensus clair — marché indécis selon le crowd._
