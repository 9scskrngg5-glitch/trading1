...
> Généré le 30/03/2026 19:50 UTC | Prix : `1.147100` | ATR : `0.001400` (0.12%)
...
| Votes LONG / SHORT / HOLD | `27%` / `36%` / `37%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 36%S / 37%H). Pas de consensus clair — marché indécis selon le crowd._
