...
> Généré le 06/04/2026 22:13 UTC | Prix : `69504.990000` | ATR : `440.070714` (0.63%)
...
| Votes LONG / SHORT / HOLD | `39%` / `33%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (39%L / 33%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
