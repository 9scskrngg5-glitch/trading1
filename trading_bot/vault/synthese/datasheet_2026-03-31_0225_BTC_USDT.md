...
> Généré le 31/03/2026 02:25 UTC | Prix : `67938.540000` | ATR : `555.844286` (0.82%)
...
| Votes LONG / SHORT / HOLD | `24%` / `41%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (24%L / 41%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
