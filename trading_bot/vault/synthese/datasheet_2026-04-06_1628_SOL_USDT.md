...
> Généré le 06/04/2026 16:28 UTC | Prix : `82.270000` | ATR : `0.662857` (0.81%)
...
| Votes LONG / SHORT / HOLD | `41%` / `31%` / `27%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (41%/31%). Prudence : la foule a souvent tort contre la structure._
