...
> Généré le 06/04/2026 04:35 UTC | Prix : `69123.690000` | ATR : `454.348571` (0.66%)
...
| Votes LONG / SHORT / HOLD | `54%` / `22%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (54%L / 22%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
