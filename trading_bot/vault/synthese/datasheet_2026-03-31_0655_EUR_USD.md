...
> Généré le 31/03/2026 06:55 UTC | Prix : `1.147200` | ATR : `0.001050` (0.09%)
...
#### Sentiment Global
> NEUTRAL — score `-2.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `30%` / `52%` / `19%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (30%/52%). Prudence : la foule a souvent tort contre la structure._
