...
> Généré le 31/03/2026 07:54 UTC | Prix : `83.410000` | ATR : `0.882143` (1.06%)
...
| Votes LONG / SHORT / HOLD | `31%` / `34%` / `36%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 34%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
