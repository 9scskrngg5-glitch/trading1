...
> Généré le 30/03/2026 22:27 UTC | Prix : `1.146900` | ATR : `0.001329` (0.12%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.40% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 1.1482 |
...
#### Sentiment Global
> POSITIVE — score `+24.6` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `26%` / `49%` / `26%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (26%/49%). Prudence : la foule a souvent tort contre la structure._
