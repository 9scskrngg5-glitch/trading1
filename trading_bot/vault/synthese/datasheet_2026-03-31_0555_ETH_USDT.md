...
> Généré le 31/03/2026 05:55 UTC | Prix : `2060.870000` | ATR : `22.034286` (1.07%)
...
#### Sentiment Global
> NEUTRAL — score `+2.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `28%` / `32%` / `40%` |
...
**Note comportementale** : _📊 Distribution équilibrée (28%L / 32%S / 40%H). Pas de consensus clair — marché indécis selon le crowd._
