...
> Généré le 31/03/2026 09:15 UTC | Prix : `2040.100000` | ATR : `20.423571` (1.00%)
...
#### Sentiment Global
> NEGATIVE — score `-26.3` sur 5 signaux fondamentaux
...
#### Détection de Biais
> ✅ Équilibré : 53% long / 47% short sur 30 signaux
...
| Votes LONG / SHORT / HOLD | `37%` / `32%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 32%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
