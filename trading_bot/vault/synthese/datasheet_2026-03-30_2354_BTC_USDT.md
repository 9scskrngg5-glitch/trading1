...
> Généré le 30/03/2026 23:54 UTC | Prix : `66784.980000` | ATR : `445.527857` (0.67%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.58% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 67048.5085 |
...
#### Sentiment Global
> POSITIVE — score `+39.2` sur 5 signaux fondamentaux
...
#### ⚡ Scalping (5m–15m)
**Direction** : `RANGE`
**Entrée** : LONG @ 66272.697500 | SHORT @ 67042.256000
...
| Votes LONG / SHORT / HOLD | `21%` / `45%` / `34%` |
| Probabilité haussière | `42%` |
| Probabilité baissière | `42%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `-25` (-50 à +50) |
| Risque manipulation crowd | `17%` |

**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (21%/45%). Prudence : la foule a souvent tort contre la structure._
