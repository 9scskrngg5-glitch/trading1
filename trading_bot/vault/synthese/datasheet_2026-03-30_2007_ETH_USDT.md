...
> Généré le 30/03/2026 20:07 UTC | Prix : `2023.700000` | ATR : `19.705000` (0.97%)
...
| Votes LONG / SHORT / HOLD | `39%` / `45%` / `16%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (39%/45%). Prudence : la foule a souvent tort contre la structure._
