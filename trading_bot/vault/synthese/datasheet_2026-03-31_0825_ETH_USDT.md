...
> Généré le 31/03/2026 08:25 UTC | Prix : `2055.970000` | ATR : `19.916429` (0.97%)
...
| Votes LONG / SHORT / HOLD | `32%` / `39%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 39%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
