...
> Généré le 30/03/2026 22:20 UTC | Prix : `1.146900` | ATR : `0.001329` (0.12%)
...
#### Sentiment Global
> NEGATIVE — score `-21.3` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `26%` / `41%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (26%L / 41%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
