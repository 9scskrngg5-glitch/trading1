...
> Généré le 31/03/2026 01:30 UTC | Prix : `1.148200` | ATR : `0.001386` (0.12%)
...
#### Sentiment Global
> NEGATIVE — score `-29.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `28%` / `39%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (28%L / 39%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
