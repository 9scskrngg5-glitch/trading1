...
> Généré le 31/03/2026 08:55 UTC | Prix : `83.100000` | ATR : `0.840714` (1.01%)
...
| Votes LONG / SHORT / HOLD | `22%` / `46%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (22%L / 46%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
