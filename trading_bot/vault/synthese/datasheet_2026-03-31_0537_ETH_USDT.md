...
> Généré le 31/03/2026 05:37 UTC | Prix : `2066.110000` | ATR : `21.657143` (1.05%)
...
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 2050.1377 |
...
| Votes LONG / SHORT / HOLD | `29%` / `18%` / `53%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 18%S / 53%H). Pas de consensus clair — marché indécis selon le crowd._
