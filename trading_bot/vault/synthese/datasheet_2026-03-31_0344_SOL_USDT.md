...
> Généré le 31/03/2026 03:44 UTC | Prix : `83.830000` | ATR : `0.927143` (1.11%)
...
| Votes LONG / SHORT / HOLD | `32%` / `40%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 40%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
