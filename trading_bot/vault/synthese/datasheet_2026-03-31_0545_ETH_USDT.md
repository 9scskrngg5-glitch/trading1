...
> Généré le 31/03/2026 05:45 UTC | Prix : `2060.870000` | ATR : `22.034286` (1.07%)
...
#### Sentiment Global
> POSITIVE — score `+31.2` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `36%` / `33%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 33%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
