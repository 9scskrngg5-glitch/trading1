...
> Généré le 31/03/2026 06:23 UTC | Prix : `2064.310000` | ATR : `21.764286` (1.05%)
...
| Votes LONG / SHORT / HOLD | `40%` / `30%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 30%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
