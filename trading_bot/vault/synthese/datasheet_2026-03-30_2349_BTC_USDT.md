...
> Généré le 30/03/2026 23:49 UTC | Prix : `66784.980000` | ATR : `445.527857` (0.67%)
...
| Votes LONG / SHORT / HOLD | `22%` / `42%` / `36%` |
...
**Note comportementale** : _📊 Distribution équilibrée (22%L / 42%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
