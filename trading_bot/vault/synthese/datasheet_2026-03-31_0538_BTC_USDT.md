...
> Généré le 31/03/2026 05:38 UTC | Prix : `67544.010000` | ATR : `514.870714` (0.76%)
...
#### Sentiment Global
> NEGATIVE — score `-24.1` sur 4 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `33%` / `40%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 40%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
