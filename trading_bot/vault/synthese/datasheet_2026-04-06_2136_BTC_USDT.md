...
> Généré le 06/04/2026 21:36 UTC | Prix : `69826.010000` | ATR : `439.455000` (0.63%)
...
| Votes LONG / SHORT / HOLD | `51%` / `21%` / `28%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 51% LONG avec support structurel. Consensus comportemental renforce l'analyse primaire._
