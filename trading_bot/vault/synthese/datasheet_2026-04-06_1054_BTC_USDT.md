...
> Généré le 06/04/2026 10:54 UTC | Prix : `69123.690000` | ATR : `454.348571` (0.66%)
...
| Votes LONG / SHORT / HOLD | `50%` / `25%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (50%L / 25%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
