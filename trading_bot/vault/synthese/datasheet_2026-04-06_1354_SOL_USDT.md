...
> Généré le 06/04/2026 13:54 UTC | Prix : `82.300000` | ATR : `0.767143` (0.93%)
...
| Votes LONG / SHORT / HOLD | `45%` / `18%` / `36%` |
...
**Note comportementale** : _📊 Distribution équilibrée (45%L / 18%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
