...
> Généré le 31/03/2026 06:52 UTC | Prix : `67681.680000` | ATR : `507.090714` (0.75%)
...
| Votes LONG / SHORT / HOLD | `35%` / `26%` / `39%` |
...
**Note comportementale** : _📊 Distribution équilibrée (35%L / 26%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
