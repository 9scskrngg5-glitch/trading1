...
> Généré le 31/03/2026 08:10 UTC | Prix : `2055.970000` | ATR : `19.916429` (0.97%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.90% |
| Type | **RANGING** | volatilité medium |
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 2051.6105 |
...
#### Sentiment Global
> NEUTRAL — score `-16.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `34%` / `37%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 37%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
