...
> Généré le 31/03/2026 06:53 UTC | Prix : `67681.680000` | ATR : `507.090714` (0.75%)
...
| Votes LONG / SHORT / HOLD | `31%` / `27%` / `42%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 27%S / 42%H). Pas de consensus clair — marché indécis selon le crowd._
