...
> Généré le 31/03/2026 02:59 UTC | Prix : `2073.000000` | ATR : `23.675000` (1.14%)
...
| Votes LONG / SHORT / HOLD | `30%` / `46%` / `25%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (30%/46%). Prudence : la foule a souvent tort contre la structure._
