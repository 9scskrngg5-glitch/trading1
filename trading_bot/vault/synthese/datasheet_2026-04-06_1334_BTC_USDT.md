...
> Généré le 06/04/2026 13:34 UTC | Prix : `69366.750000` | ATR : `431.429286` (0.62%)
...
| Votes LONG / SHORT / HOLD | `53%` / `14%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (53%L / 14%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
