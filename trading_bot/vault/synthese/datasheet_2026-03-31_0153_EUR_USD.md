...
> Généré le 31/03/2026 01:53 UTC | Prix : `1.148200` | ATR : `0.001386` (0.12%)
...
#### Sentiment Global
> NEGATIVE — score `-27.3` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `30%` / `37%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (30%L / 37%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
