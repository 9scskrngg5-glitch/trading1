...
> Généré le 30/03/2026 19:54 UTC | Prix : `82.690000` | ATR : `0.802143` (0.97%)
...
|---|---|---|
| Direction | **BULLISH** | slope 20p = +1.53% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **MARKUP** | EMA20 = 83.5365 |
...
| HVN (High Vol. Nodes) | `81.0295` | `82.6405` | `83.3565` |
...
- 🧱 Fake wall potentiel côté BID — OB imbalance +0.62 mais prix baisse

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> NEGATIVE — score `-22.8` sur 5 signaux fondamentaux
...
#### ⚡ Scalping (5m–15m)
**Direction** : `LONG`
**Entrée** : 82.690000 (niveau courant)
**SL** : `82.369143` | **TP** : `83.331714` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
#### ⚡ Scalping Contrarian
**Direction** : `SHORT`
**Entrée** : 84.935 (résistance R1)
**SL** : `85.255857` | **TP** : `84.293286` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
#### 📊 Intraday (1h–4h)
**Direction** : `LONG`
**Entrée** : Pull-back vers 82.288929 ou OB bullish
**SL** : `81.887857` | **TP** : `84.294286` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
| Votes LONG / SHORT / HOLD | `34%` / `39%` / `27%` |
| Probabilité haussière | `49%` |
| Probabilité baissière | `38%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `-25` (-50 à +50) |
| Risque manipulation crowd | `6%` |

**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (34%/39%). Prudence : la foule a souvent tort contre la structure._
