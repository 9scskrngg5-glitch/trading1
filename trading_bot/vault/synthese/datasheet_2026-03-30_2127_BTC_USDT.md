...
> Généré le 30/03/2026 21:27 UTC | Prix : `66866.410000` | ATR : `448.105000` (0.67%)
...
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 67081.4200 |
...
| Votes LONG / SHORT / HOLD | `27%` / `49%` / `24%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (27%/49%). Prudence : la foule a souvent tort contre la structure._
