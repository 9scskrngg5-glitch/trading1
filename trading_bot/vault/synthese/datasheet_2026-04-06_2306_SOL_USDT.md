...
> Généré le 06/04/2026 23:06 UTC | Prix : `80.170000` | ATR : `0.669286` (0.83%)
...
#### Sentiment Global
> POSITIVE — score `+25.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `29%` / `41%` / `30%` |
