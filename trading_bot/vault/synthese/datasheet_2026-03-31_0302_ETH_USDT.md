...
> Généré le 31/03/2026 03:02 UTC | Prix : `2073.090000` | ATR : `24.092857` (1.16%)
...
| Votes LONG / SHORT / HOLD | `40%` / `33%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 33%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
