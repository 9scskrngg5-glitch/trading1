...
> Généré le 06/04/2026 22:29 UTC | Prix : `2139.540000` | ATR : `16.438571` (0.77%)
...
| Votes LONG / SHORT / HOLD | `45%` / `25%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (45%L / 25%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
