...
> Généré le 06/04/2026 13:41 UTC | Prix : `69366.750000` | ATR : `431.429286` (0.62%)
...
#### Sentiment Global
> POSITIVE — score `+22.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `52%` / `13%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (52%L / 13%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
