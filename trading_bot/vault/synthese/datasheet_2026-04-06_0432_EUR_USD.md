...
> Généré le 06/04/2026 04:32 UTC | Prix : `1.152300` | ATR : `0.000657` (0.06%)
...
|---|---|---|
| BSL (Buy-Side) | `1.15235` | Stops d'acheteurs — cible de stop-hunt |
...
#### ⚡ Scalping (5m–15m)
**Direction** : `RANGE`
**Entrée** : LONG @ 1.151359 | SHORT @ 1.152700
...
| Votes LONG / SHORT / HOLD | `35%` / `35%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (35%L / 35%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
