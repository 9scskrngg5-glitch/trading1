...
> Généré le 06/04/2026 22:40 UTC | Prix : `69504.990000` | ATR : `440.070714` (0.63%)
...
#### Détection de Biais
> ⚠️  BIAIS SHORT DÉTECTÉ (74% des signaux) — Rechercher activement des setups LONG. Réduire la taille des positions SHORT de 20%.
...
| Votes LONG / SHORT / HOLD | `47%` / `31%` / `23%` |
