...
> Généré le 31/03/2026 01:54 UTC | Prix : `67208.750000` | ATR : `498.372857` (0.74%)
...
#### Sentiment Global
> NEUTRAL — score `-11.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `25%` / `45%` / `30%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (25%/45%). Prudence : la foule a souvent tort contre la structure._
