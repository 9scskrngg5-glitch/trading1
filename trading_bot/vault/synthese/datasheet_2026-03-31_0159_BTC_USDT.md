...
> Généré le 31/03/2026 01:59 UTC | Prix : `67208.750000` | ATR : `498.372857` (0.74%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.42% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 67043.3694 |
...
| Votes LONG / SHORT / HOLD | `24%` / `46%` / `30%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (24%/46%). Prudence : la foule a souvent tort contre la structure._
