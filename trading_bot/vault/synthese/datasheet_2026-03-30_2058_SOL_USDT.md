...
> Généré le 30/03/2026 20:58 UTC | Prix : `82.820000` | ATR : `0.810000` (0.98%)
...
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 83.3681 |
...
| Votes LONG / SHORT / HOLD | `23%` / `39%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (23%L / 39%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
