...
> Généré le 31/03/2026 10:43 UTC | Prix : `80.550000` | ATR : `0.967857` (1.20%)
...
| Votes LONG / SHORT / HOLD | `22%` / `46%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (22%L / 46%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
