...
> Généré le 30/03/2026 21:00 UTC | Prix : `66651.400000` | ATR : `447.366429` (0.67%)
...
| Votes LONG / SHORT / HOLD | `36%` / `26%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 26%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
