...
> Généré le 06/04/2026 22:33 UTC | Prix : `2139.540000` | ATR : `16.438571` (0.77%)
...
#### Sentiment Global
> POSITIVE — score `+61.2` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `47%` / `23%` / `31%` |
