...
> Généré le 31/03/2026 06:41 UTC | Prix : `2064.310000` | ATR : `21.764286` (1.05%)
...
#### Sentiment Global
> NEUTRAL — score `-14.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `38%` / `31%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (38%L / 31%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
