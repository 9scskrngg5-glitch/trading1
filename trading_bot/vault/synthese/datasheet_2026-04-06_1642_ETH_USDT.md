...
> Généré le 06/04/2026 16:42 UTC | Prix : `2164.650000` | ATR : `16.298571` (0.75%)
...
| Votes LONG / SHORT / HOLD | `45%` / `28%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (45%L / 28%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
