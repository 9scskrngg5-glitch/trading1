...
> Généré le 06/04/2026 15:30 UTC | Prix : `82.230000` | ATR : `0.682857` (0.83%)
...
#### Sentiment Global
> NEUTRAL — score `+10.3` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `39%` / `28%` / `33%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (39%/28%). Prudence : la foule a souvent tort contre la structure._
