...
> Généré le 06/04/2026 11:30 UTC | Prix : `1.154900` | ATR : `0.000864` (0.07%)
...
#### Sentiment Global
> NEUTRAL — score `-0.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `34%` / `35%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 35%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
