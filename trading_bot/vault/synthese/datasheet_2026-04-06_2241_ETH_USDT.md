...
> Généré le 06/04/2026 22:41 UTC | Prix : `2139.540000` | ATR : `16.438571` (0.77%)
...
| Votes LONG / SHORT / HOLD | `44%` / `26%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (44%L / 26%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
