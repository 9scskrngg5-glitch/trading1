...
> Généré le 30/03/2026 19:50 UTC | Prix : `66653.460000` | ATR : `452.100000` (0.68%)
...
#### Sentiment Global
> POSITIVE — score `+39.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `33%` / `36%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 36%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
