...
> Généré le 31/03/2026 16:47 UTC | Prix : `1.154700` | ATR : `0.001871` (0.16%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = +0.68% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **TRANSITION** | EMA20 = 1.1500 |
| Volatilité ATR% | `0.16%` | 🟢 Faible |
...
| POC (Point of Control) | `1.147` |
| Value Area High (VAH) | `1.15074` |
| Value Area Low (VAL) | `1.1459` |
| HVN (High Vol. Nodes) | `1.1470` | `1.1492` | `1.1505` |
| LVN (Low Vol. Nodes) | `1.1483` | `1.1518` |
...
| Votes LONG / SHORT / HOLD | `29%` / `30%` / `41%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 30%S / 41%H). Pas de consensus clair — marché indécis selon le crowd._
