...
> Généré le 31/03/2026 06:02 UTC | Prix : `83.770000` | ATR : `0.870714` (1.04%)
...
#### Détection de Biais
> ⚠️  BIAIS SHORT DÉTECTÉ (75% des signaux) — Rechercher activement des setups LONG. Réduire la taille des positions SHORT de 20%.
...
| Votes LONG / SHORT / HOLD | `42%` / `34%` / `23%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 34%S / 23%H). Pas de consensus clair — marché indécis selon le crowd._
