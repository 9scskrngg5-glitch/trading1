...
> Généré le 06/04/2026 15:53 UTC | Prix : `82.230000` | ATR : `0.682857` (0.83%)
...
#### Sentiment Global
> NEUTRAL — score `-7.2` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `38%` / `28%` / `33%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (38%/28%). Prudence : la foule a souvent tort contre la structure._
