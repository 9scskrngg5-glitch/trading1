...
> Généré le 06/04/2026 16:18 UTC | Prix : `82.270000` | ATR : `0.662857` (0.81%)
...
| Votes LONG / SHORT / HOLD | `41%` / `32%` / `28%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (41%/32%). Prudence : la foule a souvent tort contre la structure._
