...
> Généré le 06/04/2026 12:18 UTC | Prix : `82.450000` | ATR : `0.857857` (1.04%)
...
|---|---|---|
| Direction | **BULLISH** | slope 20p = +3.76% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **MARKUP** | EMA20 = 81.5504 |
| Volatilité ATR% | `1.04%` | 🟡 Moyenne |
| Force de tendance | `37/100` | |
...
- 🧱 Fake wall potentiel côté ASK — OB imbalance -0.65 mais prix monte

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> POSITIVE — score `+31.7` sur 5 signaux fondamentaux
...
|---|---|---|
| Technique | `bullish` | `54/100` |
| Fondamental | `bullish` | `50/100` |
| Régime | `bullish` | — |
| Structure | `bullish` | — |
...
#### 📊 Intraday (1h–4h)
**Direction** : `LONG`
**Entrée** : Pull-back vers 82.021071 ou OB bullish
**SL** : `81.592143` | **TP** : `84.165714` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
**SL** : `80.734286` | **TP** : `86.739286` | **R:R** : `1:2.5`
**Timeframe** : `1d–1W`
...
| Votes LONG / SHORT / HOLD | `35%` / `30%` / `36%` |
| Probabilité haussière | `54%` |
| Probabilité baissière | `29%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `-25` (-50 à +50) |
| Risque manipulation crowd | `0%` |

**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (35%/30%). Prudence : la foule a souvent tort contre la structure._
