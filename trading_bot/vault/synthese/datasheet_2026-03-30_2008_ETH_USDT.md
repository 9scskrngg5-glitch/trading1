...
> Généré le 30/03/2026 20:08 UTC | Prix : `2023.700000` | ATR : `19.705000` (0.97%)
...
| Votes LONG / SHORT / HOLD | `38%` / `46%` / `16%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (38%/46%). Prudence : la foule a souvent tort contre la structure._
