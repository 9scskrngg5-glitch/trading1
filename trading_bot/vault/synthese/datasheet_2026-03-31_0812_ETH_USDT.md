...
> Généré le 31/03/2026 08:12 UTC | Prix : `2055.970000` | ATR : `19.916429` (0.97%)
...
#### Sentiment Global
> NEUTRAL — score `-16.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `34%` / `36%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 36%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
