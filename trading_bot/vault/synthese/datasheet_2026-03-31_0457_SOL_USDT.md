...
> Généré le 31/03/2026 04:57 UTC | Prix : `83.600000` | ATR : `0.897143` (1.07%)
...
| Votes LONG / SHORT / HOLD | `43%` / `34%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (43%L / 34%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
