...
> Généré le 31/03/2026 00:25 UTC | Prix : `66797.370000` | ATR : `455.454286` (0.68%)
...
| Votes LONG / SHORT / HOLD | `18%` / `40%` / `42%` |
...
**Note comportementale** : _📊 Distribution équilibrée (18%L / 40%S / 42%H). Pas de consensus clair — marché indécis selon le crowd._
