...
> Généré le 31/03/2026 01:30 UTC | Prix : `2036.650000` | ATR : `21.089286` (1.03%)
...
| Votes LONG / SHORT / HOLD | `19%` / `20%` / `61%` |
...
**Note comportementale** : _📊 Distribution équilibrée (19%L / 20%S / 61%H). Pas de consensus clair — marché indécis selon le crowd._
