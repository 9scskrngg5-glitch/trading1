...
> Généré le 30/03/2026 22:20 UTC | Prix : `83.150000` | ATR : `0.815000` (0.98%)
...
#### Sentiment Global
> NEUTRAL — score `-9.5` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `14%` / `30%` / `56%` |
...
**Note comportementale** : _📊 Distribution équilibrée (14%L / 30%S / 56%H). Pas de consensus clair — marché indécis selon le crowd._
