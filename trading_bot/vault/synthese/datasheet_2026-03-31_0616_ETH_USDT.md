...
> Généré le 31/03/2026 06:16 UTC | Prix : `2064.310000` | ATR : `21.764286` (1.05%)
...
#### Sentiment Global
> POSITIVE — score `+30.5` sur 5 signaux fondamentaux
...
#### Détection de Biais
> ⚠️  BIAIS LONG DÉTECTÉ (74% des signaux) — Rechercher activement des setups SHORT. Réduire la taille des positions LONG de 20%.
