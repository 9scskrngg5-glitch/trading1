...
> Généré le 31/03/2026 09:01 UTC | Prix : `82.250000` | ATR : `0.850000` (1.03%)
...
#### Sentiment Global
> POSITIVE — score `+24.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `15%` / `30%` / `55%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 30% SHORT avec support structurel. Consensus comportemental renforce l'analyse primaire._
