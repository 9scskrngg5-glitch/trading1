...
> Généré le 30/03/2026 19:55 UTC | Prix : `82.690000` | ATR : `0.802143` (0.97%)
...
#### Sentiment Global
> NEGATIVE — score `-24.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `34%` / `40%` / `27%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (34%/40%). Prudence : la foule a souvent tort contre la structure._
