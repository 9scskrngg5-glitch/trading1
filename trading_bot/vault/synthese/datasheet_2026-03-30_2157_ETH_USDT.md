...
> Généré le 30/03/2026 21:57 UTC | Prix : `2023.200000` | ATR : `19.407143` (0.96%)
...
| Votes LONG / SHORT / HOLD | `28%` / `45%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (28%L / 45%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
