...
> Généré le 31/03/2026 08:01 UTC | Prix : `2055.970000` | ATR : `19.916429` (0.97%)
...
| Votes LONG / SHORT / HOLD | `33%` / `38%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 38%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
