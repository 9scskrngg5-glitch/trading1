...
> Généré le 31/03/2026 02:33 UTC | Prix : `83.850000` | ATR : `0.927857` (1.11%)
...
#### Sentiment Global
> NEGATIVE — score `-21.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `27%` / `39%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 39%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
