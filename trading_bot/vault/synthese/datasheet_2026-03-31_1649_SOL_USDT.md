...
> Généré le 31/03/2026 16:49 UTC | Prix : `82.220000` | ATR : `1.125714` (1.37%)
...
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 82.0704 |
| Volatilité ATR% | `1.37%` | 🟡 Moyenne |
...
| Indicateur | Valeur |
|---|---|
| Volatilité réalisée (VIX) | `12.7%` — 🟢 Faible (<30%) |
...
#### Sentiment Global
> NEUTRAL — score `-1.0` sur 1 signaux fondamentaux
...
#### ⚡ Scalping (5m–15m)
**Direction** : `RANGE`
**Entrée** : LONG @ 82.050000 | SHORT @ 84.830000
...
| Votes LONG / SHORT / HOLD | `36%` / `43%` / `21%` |
| Probabilité haussière | `47%` |
| Probabilité baissière | `43%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `0%` |

**Note comportementale** : _📊 Distribution équilibrée (36%L / 43%S / 21%H). Pas de consensus clair — marché indécis selon le crowd._
