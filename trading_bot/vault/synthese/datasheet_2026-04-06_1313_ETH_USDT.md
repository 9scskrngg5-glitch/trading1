...
> Généré le 06/04/2026 13:13 UTC | Prix : `2143.590000` | ATR : `18.072143` (0.84%)
...
|---|---|---|
| Direction | **BULLISH** | slope 20p = +3.93% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **MARKUP** | EMA20 = 2118.0878 |
| Volatilité ATR% | `0.84%` | 🟡 Moyenne |
| Force de tendance | `39/100` | |
...
#### 📊 Intraday (1h–4h)
**Direction** : `LONG`
**Entrée** : Pull-back vers 2134.553929 ou OB bullish
**SL** : `2125.517857` | **TP** : `2179.734286` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
**SL** : `2107.445714` | **TP** : `2233.950714` | **R:R** : `1:2.5`
**Timeframe** : `1d–1W`
...
| Votes LONG / SHORT / HOLD | `52%` / `18%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (52%L / 18%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
