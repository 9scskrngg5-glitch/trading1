...
> Généré le 06/04/2026 13:27 UTC | Prix : `2143.590000` | ATR : `18.072143` (0.84%)
...
#### Sentiment Global
> POSITIVE — score `+27.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `52%` / `19%` / `30%` |
| Probabilité haussière | `64%` |
| Probabilité baissière | `21%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `29%` |

**Note comportementale** : _📊 Distribution équilibrée (52%L / 19%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
