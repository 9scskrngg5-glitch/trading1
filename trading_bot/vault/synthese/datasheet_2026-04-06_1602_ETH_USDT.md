...
> Généré le 06/04/2026 16:02 UTC | Prix : `2164.650000` | ATR : `16.298571` (0.75%)
...
#### Sentiment Global
> POSITIVE — score `+37.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `48%` / `24%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (48%L / 24%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
