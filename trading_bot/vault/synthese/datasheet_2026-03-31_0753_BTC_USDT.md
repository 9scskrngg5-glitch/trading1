...
> Généré le 31/03/2026 07:53 UTC | Prix : `67492.850000` | ATR : `504.093571` (0.75%)
...
| Votes LONG / SHORT / HOLD | `39%` / `40%` / `21%` |
...
**Note comportementale** : _📊 Distribution équilibrée (39%L / 40%S / 21%H). Pas de consensus clair — marché indécis selon le crowd._
