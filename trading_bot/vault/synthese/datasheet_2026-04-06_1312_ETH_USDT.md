...
> Généré le 06/04/2026 13:12 UTC | Prix : `2143.590000` | ATR : `18.072143` (0.84%)
...
- 🧱 Fake wall potentiel côté ASK — OB imbalance -0.46 mais prix monte
...
| Votes LONG / SHORT / HOLD | `53%` / `18%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (53%L / 18%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
