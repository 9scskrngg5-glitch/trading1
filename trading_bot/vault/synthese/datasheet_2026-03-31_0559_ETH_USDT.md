...
> Généré le 31/03/2026 05:59 UTC | Prix : `2060.870000` | ATR : `22.034286` (1.07%)
...
| Votes LONG / SHORT / HOLD | `33%` / `25%` / `43%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 25%S / 43%H). Pas de consensus clair — marché indécis selon le crowd._
