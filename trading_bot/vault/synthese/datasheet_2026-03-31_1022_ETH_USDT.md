...
> Généré le 31/03/2026 10:22 UTC | Prix : `2018.370000` | ATR : `21.319286` (1.06%)
...
#### Détection de Biais
> ✅ Équilibré : 43% long / 57% short sur 7 signaux
...
| Votes LONG / SHORT / HOLD | `31%` / `28%` / `41%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 31% LONG avec support structurel. Consensus comportemental renforce l'analyse primaire._
