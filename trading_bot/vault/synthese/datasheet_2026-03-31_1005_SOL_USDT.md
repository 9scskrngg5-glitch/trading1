...
> Généré le 31/03/2026 10:05 UTC | Prix : `80.550000` | ATR : `0.967857` (1.20%)
...
#### Sentiment Global
> NEUTRAL — score `-0.2` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `33%` / `41%` / `26%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 41% SHORT avec support structurel. Consensus comportemental renforce l'analyse primaire._
