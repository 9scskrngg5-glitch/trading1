...
> Généré le 30/03/2026 22:00 UTC | Prix : `1.147100` | ATR : `0.001279` (0.11%)
...
| Votes LONG / SHORT / HOLD | `29%` / `28%` / `44%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 28%S / 44%H). Pas de consensus clair — marché indécis selon le crowd._
