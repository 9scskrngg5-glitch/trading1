...
> Généré le 06/04/2026 14:37 UTC | Prix : `2145.990000` | ATR : `15.955000` (0.74%)
...
| Votes LONG / SHORT / HOLD | `43%` / `25%` / `32%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (43%/25%). Prudence : la foule a souvent tort contre la structure._
