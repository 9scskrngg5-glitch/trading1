...
> Généré le 31/03/2026 09:00 UTC | Prix : `2040.100000` | ATR : `20.423571` (1.00%)
...
| Votes LONG / SHORT / HOLD | `34%` / `33%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 33%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
