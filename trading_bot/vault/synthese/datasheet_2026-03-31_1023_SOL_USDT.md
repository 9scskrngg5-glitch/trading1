...
> Généré le 31/03/2026 10:23 UTC | Prix : `80.550000` | ATR : `0.967857` (1.20%)
...
| Votes LONG / SHORT / HOLD | `23%` / `45%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (23%L / 45%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
