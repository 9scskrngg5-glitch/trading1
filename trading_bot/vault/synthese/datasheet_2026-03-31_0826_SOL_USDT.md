...
> Généré le 31/03/2026 08:26 UTC | Prix : `83.100000` | ATR : `0.840714` (1.01%)
...
#### Sentiment Global
> NEGATIVE — score `-31.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `25%` / `44%` / `32%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 44% SHORT avec support structurel. Consensus comportemental renforce l'analyse primaire._
