...
> Généré le 31/03/2026 07:38 UTC | Prix : `83.410000` | ATR : `0.882143` (1.06%)
...
| Votes LONG / SHORT / HOLD | `34%` / `32%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 32%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
