...
> Généré le 31/03/2026 07:00 UTC | Prix : `67492.850000` | ATR : `504.093571` (0.75%)
...
| Votes LONG / SHORT / HOLD | `36%` / `43%` / `20%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 43%S / 20%H). Pas de consensus clair — marché indécis selon le crowd._
