...
> Généré le 31/03/2026 03:42 UTC | Prix : `1.148500` | ATR : `0.001336` (0.12%)
...
#### Sentiment Global
> NEGATIVE — score `-30.5` sur 5 signaux fondamentaux
...
#### Détection de Biais
> ⚠️  BIAIS SHORT DÉTECTÉ (93% des signaux) — Rechercher activement des setups LONG. Réduire la taille des positions SHORT de 20%.
...
| Votes LONG / SHORT / HOLD | `29%` / `37%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 37%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
