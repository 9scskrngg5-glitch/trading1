...
> Généré le 30/03/2026 19:56 UTC | Prix : `2032.610000` | ATR : `19.312143` (0.95%)
...
#### Sentiment Global
> POSITIVE — score `+31.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `46%` / `36%` / `18%` |
...
**Note comportementale** : _📊 Distribution équilibrée (46%L / 36%S / 18%H). Pas de consensus clair — marché indécis selon le crowd._
