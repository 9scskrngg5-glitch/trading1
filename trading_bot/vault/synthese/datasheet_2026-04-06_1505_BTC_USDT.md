...
> Généré le 06/04/2026 15:05 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
#### Sentiment Global
> NEUTRAL — score `+8.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `53%` / `15%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (53%L / 15%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
