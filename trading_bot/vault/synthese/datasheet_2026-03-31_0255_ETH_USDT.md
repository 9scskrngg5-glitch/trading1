...
> Généré le 31/03/2026 02:55 UTC | Prix : `2073.000000` | ATR : `23.675000` (1.14%)
...
| Votes LONG / SHORT / HOLD | `32%` / `43%` / `25%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 43%S / 25%H). Pas de consensus clair — marché indécis selon le crowd._
