...
> Généré le 31/03/2026 10:14 UTC | Prix : `1.147400` | ATR : `0.001071` (0.09%)
...
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 1.1478 |
...
| Percentile session | `53e percentile` |
...
| Votes LONG / SHORT / HOLD | `34%` / `33%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 33%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
