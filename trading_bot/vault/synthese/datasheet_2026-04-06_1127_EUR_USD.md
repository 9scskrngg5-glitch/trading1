...
> Généré le 06/04/2026 11:27 UTC | Prix : `1.154900` | ATR : `0.000864` (0.07%)
...
| Votes LONG / SHORT / HOLD | `36%` / `33%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 33%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
