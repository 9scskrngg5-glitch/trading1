...
> Généré le 06/04/2026 10:51 UTC | Prix : `69123.690000` | ATR : `454.348571` (0.66%)
...
#### Sentiment Global
> POSITIVE — score `+30.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `54%` / `20%` / `25%` |
...
**Note comportementale** : _📊 Distribution équilibrée (54%L / 20%S / 25%H). Pas de consensus clair — marché indécis selon le crowd._
