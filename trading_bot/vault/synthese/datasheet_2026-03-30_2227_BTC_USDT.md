...
> Généré le 30/03/2026 22:27 UTC | Prix : `66809.300000` | ATR : `448.105000` (0.67%)
...
#### Sentiment Global
> NEUTRAL — score `-13.6` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `32%` / `51%` / `16%` |
| Probabilité haussière | `42%` |
| Probabilité baissière | `50%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `-25` (-50 à +50) |
| Risque manipulation crowd | `8%` |

**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (32%/51%). Prudence : la foule a souvent tort contre la structure._
