...
> Généré le 06/04/2026 14:45 UTC | Prix : `2145.990000` | ATR : `15.955000` (0.74%)
...
| Votes LONG / SHORT / HOLD | `46%` / `23%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (46%L / 23%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
