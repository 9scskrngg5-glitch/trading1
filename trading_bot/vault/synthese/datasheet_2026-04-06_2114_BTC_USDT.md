...
> Généré le 06/04/2026 21:14 UTC | Prix : `69826.010000` | ATR : `439.455000` (0.63%)
...
#### Sentiment Global
> POSITIVE — score `+38.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `52%` / `20%` / `28%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 52% LONG avec support structurel. Consensus comportemental renforce l'analyse primaire._
