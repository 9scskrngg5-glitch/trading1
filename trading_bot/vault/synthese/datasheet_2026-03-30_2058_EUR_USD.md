...
> Généré le 30/03/2026 20:58 UTC | Prix : `1.146800` | ATR : `0.001379` (0.12%)
...
| Votes LONG / SHORT / HOLD | `27%` / `33%` / `40%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 33%S / 40%H). Pas de consensus clair — marché indécis selon le crowd._
