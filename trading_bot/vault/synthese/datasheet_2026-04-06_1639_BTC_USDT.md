...
> Généré le 06/04/2026 16:39 UTC | Prix : `69968.870000` | ATR : `405.074286` (0.58%)
...
#### Sentiment Global
> POSITIVE — score `+37.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `44%` / `27%` / `29%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (44%/27%). Prudence : la foule a souvent tort contre la structure._
