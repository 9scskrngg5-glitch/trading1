...
> Généré le 31/03/2026 05:48 UTC | Prix : `83.340000` | ATR : `0.871429` (1.05%)
...
| Votes LONG / SHORT / HOLD | `29%` / `40%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 40%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
