...
> Généré le 06/04/2026 13:40 UTC | Prix : `2143.590000` | ATR : `18.072143` (0.84%)
...
#### Sentiment Global
> NEUTRAL — score `-11.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `54%` / `20%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (54%L / 20%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
