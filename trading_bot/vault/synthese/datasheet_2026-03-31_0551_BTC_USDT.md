...
> Généré le 31/03/2026 05:51 UTC | Prix : `67544.010000` | ATR : `514.870714` (0.76%)
...
| Votes LONG / SHORT / HOLD | `38%` / `36%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (38%L / 36%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
