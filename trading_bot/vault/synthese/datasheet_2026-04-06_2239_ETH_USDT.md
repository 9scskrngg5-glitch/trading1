...
> Généré le 06/04/2026 22:39 UTC | Prix : `2139.540000` | ATR : `16.438571` (0.77%)
...
| Votes LONG / SHORT / HOLD | `44%` / `25%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (44%L / 25%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
