...
> Généré le 31/03/2026 07:21 UTC | Prix : `67492.850000` | ATR : `504.093571` (0.75%)
...
| Votes LONG / SHORT / HOLD | `35%` / `44%` / `20%` |
...
**Note comportementale** : _📊 Distribution équilibrée (35%L / 44%S / 20%H). Pas de consensus clair — marché indécis selon le crowd._
