...
> Généré le 31/03/2026 03:40 UTC | Prix : `2073.090000` | ATR : `24.092857` (1.16%)
...
| Votes LONG / SHORT / HOLD | `36%` / `34%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 34%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
