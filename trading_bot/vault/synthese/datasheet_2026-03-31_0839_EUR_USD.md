...
> Généré le 31/03/2026 08:39 UTC | Prix : `1.147800` | ATR : `0.001057` (0.09%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.10% |
...
| LVN (Low Vol. Nodes) | `1.1485` | `1.1495` |
...
- 🧱 Fake wall potentiel côté BID — OB imbalance +0.41 mais prix baisse

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> POSITIVE — score `+23.8` sur 5 signaux fondamentaux
