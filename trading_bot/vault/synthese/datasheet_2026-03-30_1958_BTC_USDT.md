...
> Généré le 30/03/2026 19:58 UTC | Prix : `66653.460000` | ATR : `452.100000` (0.68%)
...
| Votes LONG / SHORT / HOLD | `31%` / `39%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 39%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
