...
> Généré le 06/04/2026 15:30 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
#### Sentiment Global
> NEUTRAL — score `+17.3` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `54%` / `12%` / `33%` |
| Probabilité haussière | `71%` |
| Probabilité baissière | `12%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `19%` |

**Note comportementale** : _📊 Distribution équilibrée (54%L / 12%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
