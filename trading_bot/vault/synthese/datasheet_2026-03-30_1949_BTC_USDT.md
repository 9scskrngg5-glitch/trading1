...
> Généré le 30/03/2026 19:49 UTC | Prix : `66653.460000` | ATR : `452.100000` (0.68%)
...
#### Sentiment Global
> POSITIVE — score `+49.6` sur 4 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `34%` / `35%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 35%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
