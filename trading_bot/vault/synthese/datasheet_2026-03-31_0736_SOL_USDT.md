...
> Généré le 31/03/2026 07:36 UTC | Prix : `83.410000` | ATR : `0.882143` (1.06%)
...
| Votes LONG / SHORT / HOLD | `35%` / `34%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (35%L / 34%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
