...
> Généré le 06/04/2026 11:54 UTC | Prix : `82.680000` | ATR : `0.880000` (1.06%)
...
#### Sentiment Global
> POSITIVE — score `+38.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `39%` / `37%` / `23%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (39%/37%). Prudence : la foule a souvent tort contre la structure._
