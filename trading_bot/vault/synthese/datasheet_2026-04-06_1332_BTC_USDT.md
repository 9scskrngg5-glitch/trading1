...
> Généré le 06/04/2026 13:32 UTC | Prix : `69366.750000` | ATR : `431.429286` (0.62%)
...
| Votes LONG / SHORT / HOLD | `52%` / `15%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (52%L / 15%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
