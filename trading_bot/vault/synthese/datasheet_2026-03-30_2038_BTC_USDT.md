...
> Généré le 30/03/2026 20:38 UTC | Prix : `66550.050000` | ATR : `457.345714` (0.69%)
...
| Votes LONG / SHORT / HOLD | `20%` / `42%` / `39%` |
...
**Note comportementale** : _📊 Distribution équilibrée (20%L / 42%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
