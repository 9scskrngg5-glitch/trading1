...
> Généré le 06/04/2026 15:41 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
#### Sentiment Global
> POSITIVE — score `+28.6` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `55%` / `10%` / `34%` |
| Probabilité haussière | `72%` |
| Probabilité baissière | `11%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `28%` |

**Note comportementale** : _📊 Distribution équilibrée (55%L / 10%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
