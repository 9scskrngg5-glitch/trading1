...
> Généré le 06/04/2026 21:13 UTC | Prix : `2145.950000` | ATR : `15.917143` (0.74%)
...
| Phase (Wyckoff) | **TRANSITION** | EMA20 = 2135.1500 |
...
| Votes LONG / SHORT / HOLD | `39%` / `22%` / `40%` |
...
**Note comportementale** : _📊 Distribution équilibrée (39%L / 22%S / 40%H). Pas de consensus clair — marché indécis selon le crowd._
