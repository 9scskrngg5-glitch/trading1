...
> Généré le 31/03/2026 03:46 UTC | Prix : `67943.430000` | ATR : `556.410714` (0.82%)
...
| Votes LONG / SHORT / HOLD | `40%` / `29%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 29%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
