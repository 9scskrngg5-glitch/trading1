...
> Généré le 31/03/2026 05:58 UTC | Prix : `2060.870000` | ATR : `22.034286` (1.07%)
...
#### Détection de Biais
> ✅ Équilibré : 57% long / 43% short sur 14 signaux
...
| Votes LONG / SHORT / HOLD | `32%` / `26%` / `43%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 26%S / 43%H). Pas de consensus clair — marché indécis selon le crowd._
