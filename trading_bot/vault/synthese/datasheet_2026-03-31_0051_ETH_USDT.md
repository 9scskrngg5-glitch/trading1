...
> Généré le 31/03/2026 00:51 UTC | Prix : `2026.480000` | ATR : `20.047143` (0.99%)
...
| Votes LONG / SHORT / HOLD | `32%` / `48%` / `21%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (32%/48%). Prudence : la foule a souvent tort contre la structure._
