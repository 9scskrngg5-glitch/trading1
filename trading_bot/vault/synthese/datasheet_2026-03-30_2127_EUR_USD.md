...
> Généré le 30/03/2026 21:27 UTC | Prix : `1.146700` | ATR : `0.001293` (0.11%)
...
| Swing Highs récents | `1.1510` | `1.1526` | `1.1504` | `1.1474` |
|---|---|
...
|---|---|---|---|
| R1 | `1.150692` | `100/100` | `12` touches |
...
#### ⚡ Scalping (5m–15m)
**Direction** : `RANGE`
**Entrée** : LONG @ 1.145000 | SHORT @ 1.150692
...
| Votes LONG / SHORT / HOLD | `27%` / `44%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 44%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
