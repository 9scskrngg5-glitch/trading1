...
> Généré le 30/03/2026 23:30 UTC | Prix : `66701.590000` | ATR : `454.568571` (0.68%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -1.35% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 67015.8031 |
...
| HVN (High Vol. Nodes) | `66625.0400` | `66727.0040` | `66828.9680` |
| LVN (Low Vol. Nodes) | — |
...
| Votes LONG / SHORT / HOLD | `34%` / `47%` / `19%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (34%/47%). Prudence : la foule a souvent tort contre la structure._
