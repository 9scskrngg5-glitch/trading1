...
> Généré le 31/03/2026 01:49 UTC | Prix : `67208.750000` | ATR : `498.372857` (0.74%)
...
| Votes LONG / SHORT / HOLD | `27%` / `48%` / `26%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (27%/48%). Prudence : la foule a souvent tort contre la structure._
