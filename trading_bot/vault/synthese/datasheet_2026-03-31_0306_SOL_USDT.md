...
> Généré le 31/03/2026 03:06 UTC | Prix : `83.830000` | ATR : `0.927143` (1.11%)
...
| Votes LONG / SHORT / HOLD | `34%` / `38%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 38%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
