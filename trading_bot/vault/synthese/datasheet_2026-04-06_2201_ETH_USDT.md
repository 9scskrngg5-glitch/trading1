...
> Généré le 06/04/2026 22:01 UTC | Prix : `2139.540000` | ATR : `16.438571` (0.77%)
...
| Votes LONG / SHORT / HOLD | `40%` / `30%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 30%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
