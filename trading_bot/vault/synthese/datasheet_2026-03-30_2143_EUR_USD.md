...
> Généré le 30/03/2026 21:43 UTC | Prix : `1.147200` | ATR : `0.001329` (0.12%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.37% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 1.1482 |
...
| Votes LONG / SHORT / HOLD | `30%` / `39%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (30%L / 39%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
