...
> Généré le 31/03/2026 10:29 UTC | Prix : `1.147500` | ATR : `0.001079` (0.09%)
...
#### Détection de Biais
> ✅ Équilibré : 36% long / 64% short sur 28 signaux
...
| Votes LONG / SHORT / HOLD | `31%` / `31%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 31%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
