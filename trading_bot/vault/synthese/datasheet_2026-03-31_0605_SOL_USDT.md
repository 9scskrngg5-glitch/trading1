...
> Généré le 31/03/2026 06:05 UTC | Prix : `83.770000` | ATR : `0.870714` (1.04%)
...
| Votes LONG / SHORT / HOLD | `42%` / `36%` / `23%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 36%S / 23%H). Pas de consensus clair — marché indécis selon le crowd._
