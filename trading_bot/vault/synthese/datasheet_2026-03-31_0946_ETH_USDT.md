...
> Généré le 31/03/2026 09:46 UTC | Prix : `2040.100000` | ATR : `20.423571` (1.00%)
...
#### Détection de Biais
> ⚠️  BIAIS SHORT DÉTECTÉ (97% des signaux) — Rechercher activement des setups LONG. Réduire la taille des positions SHORT de 20%.
...
| Votes LONG / SHORT / HOLD | `36%` / `32%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 32%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
