...
> Généré le 31/03/2026 07:12 UTC | Prix : `2062.330000` | ATR : `21.315000` (1.03%)
...
| Votes LONG / SHORT / HOLD | `40%` / `25%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 25%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
