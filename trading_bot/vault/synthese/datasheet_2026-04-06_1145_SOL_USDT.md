...
> Généré le 06/04/2026 11:45 UTC | Prix : `82.680000` | ATR : `0.880000` (1.06%)
...
#### ⚡ Scalping (5m–15m)
**Direction** : `LONG`
**Entrée** : 82.680000 (niveau courant)
**SL** : `82.328` | **TP** : `83.384` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
| Votes LONG / SHORT / HOLD | `38%` / `39%` / `23%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (38%/39%). Prudence : la foule a souvent tort contre la structure._
