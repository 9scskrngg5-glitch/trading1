...
> Généré le 31/03/2026 07:23 UTC | Prix : `1.148100` | ATR : `0.001064` (0.09%)
...
#### Sentiment Global
> POSITIVE — score `+21.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `31%` / `50%` / `19%` |
| Probabilité haussière | `39%` |
| Probabilité baissière | `52%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `-25` (-50 à +50) |
| Risque manipulation crowd | `7%` |

**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (31%/50%). Prudence : la foule a souvent tort contre la structure._
