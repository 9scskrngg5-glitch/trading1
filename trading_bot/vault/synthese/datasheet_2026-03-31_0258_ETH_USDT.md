...
> Généré le 31/03/2026 02:58 UTC | Prix : `2073.000000` | ATR : `23.675000` (1.14%)
...
#### Sentiment Global
> NEUTRAL — score `-18.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `30%` / `45%` / `25%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (30%/45%). Prudence : la foule a souvent tort contre la structure._
