...
> Généré le 06/04/2026 13:41 UTC | Prix : `82.300000` | ATR : `0.767143` (0.93%)
...
| Votes LONG / SHORT / HOLD | `42%` / `23%` / `36%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (42%/23%). Prudence : la foule a souvent tort contre la structure._
