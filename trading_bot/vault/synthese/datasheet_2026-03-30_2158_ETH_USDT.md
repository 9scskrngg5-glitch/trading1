...
> Généré le 30/03/2026 21:58 UTC | Prix : `2037.730000` | ATR : `19.492857` (0.96%)
...
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 2041.3273 |
...
| Votes LONG / SHORT / HOLD | `39%` / `30%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (39%L / 30%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
