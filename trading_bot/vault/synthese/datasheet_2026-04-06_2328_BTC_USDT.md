...
> Généré le 06/04/2026 23:28 UTC | Prix : `68811.000000` | ATR : `476.138571` (0.69%)
...
| Votes LONG / SHORT / HOLD | `41%` / `28%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (41%L / 28%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
