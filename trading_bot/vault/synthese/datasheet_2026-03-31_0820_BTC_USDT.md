...
> Généré le 31/03/2026 08:20 UTC | Prix : `67367.690000` | ATR : `475.960000` (0.71%)
...
#### Sentiment Global
> NEUTRAL — score `-2.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `44%` / `27%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (44%L / 27%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
