...
> Généré le 06/04/2026 21:25 UTC | Prix : `69826.010000` | ATR : `439.455000` (0.63%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = +1.48% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **TRANSITION** | EMA20 = 69338.8286 |
...
| Indicateur | Valeur |
|---|---|
| Volatilité réalisée (VIX) | `5.8%` — 🟢 Faible (<30%) |
...
#### Sentiment Global
> POSITIVE — score `+41.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `50%` / `23%` / `26%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 50% LONG avec support structurel. Consensus comportemental renforce l'analyse primaire._
