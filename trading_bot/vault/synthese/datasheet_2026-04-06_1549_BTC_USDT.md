...
> Généré le 06/04/2026 15:49 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
- 🧱 Fake wall potentiel côté BID — OB imbalance +0.68 mais prix baisse

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> NEUTRAL — score `+3.4` sur 5 signaux fondamentaux
...
|---|---|---|
| Technique | `bullish` | `60/100` |
| Fondamental | `neutral` | `5/100` |
| Régime | `bullish` | — |
| Structure | `bullish` | — |
...
| Votes LONG / SHORT / HOLD | `54%` / `12%` / `34%` |
| Probabilité haussière | `71%` |
| Probabilité baissière | `12%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `33%` |

**Note comportementale** : _📊 Distribution équilibrée (54%L / 12%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
