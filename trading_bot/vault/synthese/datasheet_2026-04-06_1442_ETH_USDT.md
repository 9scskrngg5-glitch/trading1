...
> Généré le 06/04/2026 14:42 UTC | Prix : `2145.990000` | ATR : `15.955000` (0.74%)
...
| Votes LONG / SHORT / HOLD | `45%` / `23%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (45%L / 23%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
