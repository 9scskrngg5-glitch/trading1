...
> Généré le 06/04/2026 11:17 UTC | Prix : `1.154700` | ATR : `0.001293` (0.11%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = +0.25% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 1.1534 |
...
| Swing Highs récents | `1.1516` | `1.1523` | `1.1572` | `1.1572` |
|---|---|
...
|---|---|---|
| BSL (Buy-Side) | `1.1572` | Stops d'acheteurs — cible de stop-hunt |
...
| Votes LONG / SHORT / HOLD | `38%` / `35%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (38%L / 35%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
