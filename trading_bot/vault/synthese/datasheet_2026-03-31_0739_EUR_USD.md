...
> Généré le 31/03/2026 07:39 UTC | Prix : `1.148100` | ATR : `0.001064` (0.09%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.08% |
...
| Percentile session | `63e percentile` |
...
| LVN (Low Vol. Nodes) | `1.1479` | `1.1495` |
...
#### Sentiment Global
> NEGATIVE — score `-35.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `28%` / `53%` / `19%` |
| Probabilité haussière | `37%` |
| Probabilité baissière | `54%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `-25` (-50 à +50) |
| Risque manipulation crowd | `7%` |

**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (28%/53%). Prudence : la foule a souvent tort contre la structure._
