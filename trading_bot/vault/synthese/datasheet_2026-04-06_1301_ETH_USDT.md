...
> Généré le 06/04/2026 13:01 UTC | Prix : `2143.590000` | ATR : `18.072143` (0.84%)
...
- 🧱 Fake wall potentiel côté ASK — OB imbalance -0.68 mais prix monte

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> POSITIVE — score `+38.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `53%` / `19%` / `28%` |
| Probabilité haussière | `60%` |
| Probabilité baissière | `26%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `32%` |

**Note comportementale** : _📊 Distribution équilibrée (53%L / 19%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
