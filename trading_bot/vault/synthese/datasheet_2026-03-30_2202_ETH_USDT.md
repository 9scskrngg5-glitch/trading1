...
> Généré le 30/03/2026 22:02 UTC | Prix : `2036.000000` | ATR : `19.492857` (0.96%)
...
| Votes LONG / SHORT / HOLD | `33%` / `33%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 33%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
