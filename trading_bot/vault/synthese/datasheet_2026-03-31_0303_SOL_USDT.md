...
> Généré le 31/03/2026 03:03 UTC | Prix : `83.830000` | ATR : `0.927143` (1.11%)
...
#### Sentiment Global
> NEUTRAL — score `+18.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `32%` / `40%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 40%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
