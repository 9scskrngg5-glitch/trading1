...
> Généré le 30/03/2026 19:54 UTC | Prix : `1.147100` | ATR : `0.001400` (0.12%)
...
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 1.1487 |
...
| Indicateur | Valeur |
|---|---|
| Volatilité réalisée (VIX) | `0.8%` — 🟢 Faible (<30%) |
| Percentile session | `100e percentile` |
| POC (Point of Control) | `1.150395` |
| Value Area High (VAH) | `1.15117` |
| Value Area Low (VAL) | `1.14869` |
| HVN (High Vol. Nodes) | `1.1492` | `1.1501` | `1.1504` |
| LVN (Low Vol. Nodes) | — |
...
| Votes LONG / SHORT / HOLD | `27%` / `35%` / `37%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 35%S / 37%H). Pas de consensus clair — marché indécis selon le crowd._
