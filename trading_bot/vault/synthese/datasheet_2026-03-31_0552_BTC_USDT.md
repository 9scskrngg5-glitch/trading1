...
> Généré le 31/03/2026 05:52 UTC | Prix : `67544.010000` | ATR : `514.870714` (0.76%)
...
#### Détection de Biais
> ✅ Équilibré : 58% long / 42% short sur 12 signaux
...
| Votes LONG / SHORT / HOLD | `37%` / `36%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 36%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
