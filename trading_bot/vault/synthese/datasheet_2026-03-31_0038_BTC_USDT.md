...
> Généré le 31/03/2026 00:38 UTC | Prix : `66797.370000` | ATR : `455.454286` (0.68%)
...
| Votes LONG / SHORT / HOLD | `16%` / `42%` / `43%` |
...
**Note comportementale** : _📊 Distribution équilibrée (16%L / 42%S / 43%H). Pas de consensus clair — marché indécis selon le crowd._
