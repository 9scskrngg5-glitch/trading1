...
> Généré le 31/03/2026 07:08 UTC | Prix : `1.148100` | ATR : `0.001064` (0.09%)
...
| Votes LONG / SHORT / HOLD | `32%` / `49%` / `20%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (32%/49%). Prudence : la foule a souvent tort contre la structure._
