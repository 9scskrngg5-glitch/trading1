...
> Généré le 31/03/2026 07:26 UTC | Prix : `1.148100` | ATR : `0.001064` (0.09%)
...
#### Sentiment Global
> NEUTRAL — score `+19.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `30%` / `51%` / `19%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (30%/51%). Prudence : la foule a souvent tort contre la structure._
