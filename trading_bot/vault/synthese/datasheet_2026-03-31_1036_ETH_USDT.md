...
> Généré le 31/03/2026 10:36 UTC | Prix : `2018.370000` | ATR : `21.319286` (1.06%)
...
#### Détection de Biais
> ✅ Équilibré : 50% long / 50% short sur 18 signaux
...
| Votes LONG / SHORT / HOLD | `32%` / `28%` / `41%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 32% LONG avec support structurel. Consensus comportemental renforce l'analyse primaire._
