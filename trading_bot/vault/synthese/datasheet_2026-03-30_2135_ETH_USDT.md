...
> Généré le 30/03/2026 21:35 UTC | Prix : `2023.200000` | ATR : `19.407143` (0.96%)
...
#### Sentiment Global
> NEUTRAL — score `-5.6` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `34%` / `43%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 43%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
