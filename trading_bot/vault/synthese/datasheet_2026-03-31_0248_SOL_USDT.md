...
> Généré le 31/03/2026 02:48 UTC | Prix : `83.850000` | ATR : `0.927857` (1.11%)
...
| Votes LONG / SHORT / HOLD | `31%` / `36%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 36%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
