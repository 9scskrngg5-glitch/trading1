...
> Généré le 30/03/2026 20:35 UTC | Prix : `1.146700` | ATR : `0.001400` (0.12%)
...
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 1.1485 |
...
#### Sentiment Global
> NEGATIVE — score `-30.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `24%` / `38%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (24%L / 38%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
