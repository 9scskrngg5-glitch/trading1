...
> Généré le 31/03/2026 05:25 UTC | Prix : `2060.870000` | ATR : `22.034286` (1.07%)
...
#### Sentiment Global
> NEUTRAL — score `+11.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `42%` / `33%` / `25%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 33%S / 25%H). Pas de consensus clair — marché indécis selon le crowd._
