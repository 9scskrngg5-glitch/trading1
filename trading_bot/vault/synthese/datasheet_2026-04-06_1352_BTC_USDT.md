...
> Généré le 06/04/2026 13:52 UTC | Prix : `69366.750000` | ATR : `431.429286` (0.62%)
...
- 🧱 Fake wall potentiel côté ASK — OB imbalance -0.59 mais prix monte

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> POSITIVE — score `+32.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `51%` / `15%` / `34%` |
| Probabilité haussière | `66%` |
| Probabilité baissière | `17%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `26%` |

**Note comportementale** : _📊 Distribution équilibrée (51%L / 15%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
