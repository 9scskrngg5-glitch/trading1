...
> Généré le 31/03/2026 01:19 UTC | Prix : `2036.650000` | ATR : `21.089286` (1.03%)
...
| Votes LONG / SHORT / HOLD | `23%` / `19%` / `59%` |
...
**Note comportementale** : _📊 Distribution équilibrée (23%L / 19%S / 59%H). Pas de consensus clair — marché indécis selon le crowd._
