...
> Généré le 06/04/2026 13:15 UTC | Prix : `82.300000` | ATR : `0.767143` (0.93%)
...
#### Sentiment Global
> NEUTRAL — score `+5.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `43%` / `20%` / `36%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (43%/20%). Prudence : la foule a souvent tort contre la structure._
