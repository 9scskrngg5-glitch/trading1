...
> Généré le 30/03/2026 19:49 UTC | Prix : `82.690000` | ATR : `0.802143` (0.97%)
...
#### Sentiment Global
> NEGATIVE — score `-31.9` sur 4 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `33%` / `39%` / `28%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (33%/39%). Prudence : la foule a souvent tort contre la structure._
