...
> Généré le 06/04/2026 21:42 UTC | Prix : `2148.810000` | ATR : `16.945000` (0.79%)
...
| Votes LONG / SHORT / HOLD | `48%` / `20%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (48%L / 20%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
