...
> Généré le 31/03/2026 08:23 UTC | Prix : `83.100000` | ATR : `0.840714` (1.01%)
...
#### Sentiment Global
> NEGATIVE — score `-22.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `25%` / `42%` / `32%` |
