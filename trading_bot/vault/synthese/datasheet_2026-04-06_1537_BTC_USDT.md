...
> Généré le 06/04/2026 15:37 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
#### Sentiment Global
> POSITIVE — score `+33.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `56%` / `10%` / `34%` |
| Probabilité haussière | `73%` |
| Probabilité baissière | `10%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `34%` |

**Note comportementale** : _📊 Distribution équilibrée (56%L / 10%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
