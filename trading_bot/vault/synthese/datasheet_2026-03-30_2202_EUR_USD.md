...
> Généré le 30/03/2026 22:02 UTC | Prix : `1.146900` | ATR : `0.001329` (0.12%)
...
| Votes LONG / SHORT / HOLD | `28%` / `28%` / `44%` |
...
**Note comportementale** : _📊 Distribution équilibrée (28%L / 28%S / 44%H). Pas de consensus clair — marché indécis selon le crowd._
