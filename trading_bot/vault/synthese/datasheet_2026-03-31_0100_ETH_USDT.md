...
> Généré le 31/03/2026 01:00 UTC | Prix : `2036.650000` | ATR : `21.089286` (1.03%)
...
| Votes LONG / SHORT / HOLD | `23%` / `18%` / `59%` |
...
**Note comportementale** : _📊 Distribution équilibrée (23%L / 18%S / 59%H). Pas de consensus clair — marché indécis selon le crowd._
