...
> Généré le 30/03/2026 20:06 UTC | Prix : `82.390000` | ATR : `0.804286` (0.98%)
...
| Votes LONG / SHORT / HOLD | `32%` / `44%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 44%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
