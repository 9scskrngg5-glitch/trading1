...
> Généré le 30/03/2026 22:22 UTC | Prix : `1.146900` | ATR : `0.001329` (0.12%)
...
#### Sentiment Global
> NEUTRAL — score `-17.2` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `28%` / `51%` / `20%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (28%/51%). Prudence : la foule a souvent tort contre la structure._
