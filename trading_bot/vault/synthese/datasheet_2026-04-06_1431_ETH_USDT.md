...
> Généré le 06/04/2026 14:31 UTC | Prix : `2145.990000` | ATR : `15.955000` (0.74%)
...
#### Sentiment Global
> POSITIVE — score `+42.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `49%` / `20%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (49%L / 20%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
