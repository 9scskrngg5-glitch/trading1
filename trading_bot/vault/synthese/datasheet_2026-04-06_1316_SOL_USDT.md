...
> Généré le 06/04/2026 13:16 UTC | Prix : `82.300000` | ATR : `0.767143` (0.93%)
...
#### Sentiment Global
> POSITIVE — score `+33.2` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `44%` / `19%` / `36%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (44%/19%). Prudence : la foule a souvent tort contre la structure._
