...
> Généré le 31/03/2026 07:06 UTC | Prix : `1.148100` | ATR : `0.001064` (0.09%)
...
#### Sentiment Global
> NEUTRAL — score `+9.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `31%` / `49%` / `20%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (31%/49%). Prudence : la foule a souvent tort contre la structure._
