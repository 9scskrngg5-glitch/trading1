...
> Généré le 06/04/2026 15:43 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
#### Sentiment Global
> POSITIVE — score `+28.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `53%` / `12%` / `35%` |
...
**Note comportementale** : _📊 Distribution équilibrée (53%L / 12%S / 35%H). Pas de consensus clair — marché indécis selon le crowd._
