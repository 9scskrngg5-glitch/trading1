...
> Généré le 31/03/2026 03:33 UTC | Prix : `67943.430000` | ATR : `556.410714` (0.82%)
...
| Votes LONG / SHORT / HOLD | `36%` / `35%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (36%L / 35%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
