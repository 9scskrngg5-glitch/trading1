...
> Généré le 06/04/2026 14:12 UTC | Prix : `82.460000` | ATR : `0.682857` (0.83%)
...
| Votes LONG / SHORT / HOLD | `39%` / `24%` / `37%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (39%/24%). Prudence : la foule a souvent tort contre la structure._
