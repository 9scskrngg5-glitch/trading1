...
> Généré le 30/03/2026 20:54 UTC | Prix : `82.790000` | ATR : `0.810000` (0.98%)
...
| Votes LONG / SHORT / HOLD | `37%` / `41%` / `22%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 41%S / 22%H). Pas de consensus clair — marché indécis selon le crowd._
