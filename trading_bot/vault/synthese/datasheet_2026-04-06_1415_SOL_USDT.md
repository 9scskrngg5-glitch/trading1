...
> Généré le 06/04/2026 14:15 UTC | Prix : `82.460000` | ATR : `0.682857` (0.83%)
...
| Votes LONG / SHORT / HOLD | `34%` / `25%` / `40%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (34%/25%). Prudence : la foule a souvent tort contre la structure._
