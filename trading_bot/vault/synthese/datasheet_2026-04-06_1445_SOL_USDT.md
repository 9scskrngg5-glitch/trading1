...
> Généré le 06/04/2026 14:45 UTC | Prix : `82.460000` | ATR : `0.682857` (0.83%)
...
#### Sentiment Global
> POSITIVE — score `+35.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `34%` / `26%` / `40%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (34%/26%). Prudence : la foule a souvent tort contre la structure._
