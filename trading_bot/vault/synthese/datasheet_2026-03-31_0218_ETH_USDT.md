...
> Généré le 31/03/2026 02:18 UTC | Prix : `2073.000000` | ATR : `23.675000` (1.14%)
...
| Votes LONG / SHORT / HOLD | `33%` / `42%` / `25%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 42%S / 25%H). Pas de consensus clair — marché indécis selon le crowd._
