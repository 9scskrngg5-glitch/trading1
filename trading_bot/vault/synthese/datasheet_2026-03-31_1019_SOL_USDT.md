...
> Généré le 31/03/2026 10:19 UTC | Prix : `80.550000` | ATR : `0.967857` (1.20%)
...
#### Détection de Biais
> ⚠️  BIAIS SHORT DÉTECTÉ (88% des signaux) — Rechercher activement des setups LONG. Réduire la taille des positions SHORT de 20%.
...
| Votes LONG / SHORT / HOLD | `22%` / `45%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (22%L / 45%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
