...
> Généré le 06/04/2026 16:40 UTC | Prix : `82.270000` | ATR : `0.662857` (0.81%)
...
#### ⚡ Scalping (5m–15m)
**Direction** : `LONG`
**Entrée** : 82.270000 (niveau courant)
**SL** : `82.004857` | **TP** : `82.800286` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
#### ⚡ Scalping Contrarian
**Direction** : `SHORT`
**Entrée** : 83.085 (résistance R1)
**SL** : `83.350143` | **TP** : `82.554714` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
| Votes LONG / SHORT / HOLD | `40%` / `31%` / `29%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (40%/31%). Prudence : la foule a souvent tort contre la structure._
