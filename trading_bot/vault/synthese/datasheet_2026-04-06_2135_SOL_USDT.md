...
> Généré le 06/04/2026 21:35 UTC | Prix : `82.000000` | ATR : `0.612143` (0.75%)
...
| Votes LONG / SHORT / HOLD | `27%` / `38%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 38%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
