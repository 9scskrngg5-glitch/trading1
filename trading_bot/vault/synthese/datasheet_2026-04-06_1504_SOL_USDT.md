...
> Généré le 06/04/2026 15:04 UTC | Prix : `82.230000` | ATR : `0.682857` (0.83%)
...
|---|---|---|
| Direction | **BULLISH** | slope 20p = +3.01% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **MARKUP** | EMA20 = 81.7518 |
...
#### Sentiment Global
> POSITIVE — score `+36.6` sur 5 signaux fondamentaux
...
#### 📊 Intraday (1h–4h)
**Direction** : `LONG`
**Entrée** : Pull-back vers 81.888571 ou OB bullish
**SL** : `81.547143` | **TP** : `83.595714` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
**SL** : `80.864286` | **TP** : `85.644286` | **R:R** : `1:2.5`
**Timeframe** : `1d–1W`
...
| Votes LONG / SHORT / HOLD | `40%` / `27%` / `33%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (40%/27%). Prudence : la foule a souvent tort contre la structure._
