...
> Généré le 30/03/2026 21:59 UTC | Prix : `66651.400000` | ATR : `447.366429` (0.67%)
...
#### Sentiment Global
> POSITIVE — score `+21.2` sur 3 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `39%` / `34%` / `27%` |
...
**Note comportementale** : _📊 Distribution équilibrée (39%L / 34%S / 27%H). Pas de consensus clair — marché indécis selon le crowd._
