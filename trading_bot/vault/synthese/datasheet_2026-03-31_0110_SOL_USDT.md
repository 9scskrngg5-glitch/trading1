...
> Généré le 31/03/2026 01:10 UTC | Prix : `82.720000` | ATR : `0.842857` (1.02%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -1.10% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 83.1751 |
| Volatilité ATR% | `1.02%` | 🟡 Moyenne |
...
#### Sentiment Global
> POSITIVE — score `+26.6` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `35%` / `47%` / `18%` |
| Probabilité haussière | `44%` |
| Probabilité baissière | `47%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `-25` (-50 à +50) |
| Risque manipulation crowd | `6%` |

**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (35%/47%). Prudence : la foule a souvent tort contre la structure._
