...
> Généré le 31/03/2026 05:14 UTC | Prix : `83.340000` | ATR : `0.871429` (1.05%)
...
| Votes LONG / SHORT / HOLD | `31%` / `35%` / `34%` |
...
**Note comportementale** : _📊 Distribution équilibrée (31%L / 35%S / 34%H). Pas de consensus clair — marché indécis selon le crowd._
