...
> Généré le 31/03/2026 16:47 UTC | Prix : `82.260000` | ATR : `1.125714` (1.37%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -1.07% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 82.0742 |
...
| Indicateur | Valeur |
|---|---|
| Volatilité réalisée (VIX) | `12.8%` — 🟢 Faible (<30%) |
...
| Votes LONG / SHORT / HOLD | `41%` / `28%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (41%L / 28%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
