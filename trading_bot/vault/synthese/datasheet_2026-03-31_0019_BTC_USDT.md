...
> Généré le 31/03/2026 00:19 UTC | Prix : `66797.370000` | ATR : `455.454286` (0.68%)
...
| Votes LONG / SHORT / HOLD | `21%` / `35%` / `44%` |
...
**Note comportementale** : _📊 Distribution équilibrée (21%L / 35%S / 44%H). Pas de consensus clair — marché indécis selon le crowd._
