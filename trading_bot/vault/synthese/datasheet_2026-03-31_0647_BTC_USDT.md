...
> Généré le 31/03/2026 06:47 UTC | Prix : `67681.680000` | ATR : `507.090714` (0.75%)
...
| Votes LONG / SHORT / HOLD | `32%` / `30%` / `39%` |
...
**Note comportementale** : _📊 Distribution équilibrée (32%L / 30%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
