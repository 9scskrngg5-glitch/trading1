...
> Généré le 06/04/2026 11:25 UTC | Prix : `1.154900` | ATR : `0.000864` (0.07%)
...
#### Sentiment Global
> POSITIVE — score `+23.6` sur 5 signaux fondamentaux
...
|---|---|---|
| Technique | `bullish` | `26/100` |
| Fondamental | `bullish` | `17/100` |
| Régime | `neutral` | — |
| Structure | `bearish` | — |
...
| Votes LONG / SHORT / HOLD | `37%` / `33%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 33%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
