...
> Généré le 31/03/2026 01:00 UTC | Prix : `1.148200` | ATR : `0.001386` (0.12%)
...
#### Sentiment Global
> NEUTRAL — score `-3.1` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `29%` / `38%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 38%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
