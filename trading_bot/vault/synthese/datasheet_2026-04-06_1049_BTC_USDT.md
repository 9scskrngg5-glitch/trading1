...
> Généré le 06/04/2026 10:49 UTC | Prix : `69123.690000` | ATR : `454.348571` (0.66%)
...
| Votes LONG / SHORT / HOLD | `54%` / `21%` / `25%` |
...
**Note comportementale** : _📊 Distribution équilibrée (54%L / 21%S / 25%H). Pas de consensus clair — marché indécis selon le crowd._
