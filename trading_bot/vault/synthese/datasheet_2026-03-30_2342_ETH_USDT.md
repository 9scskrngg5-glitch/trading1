...
> Généré le 30/03/2026 23:42 UTC | Prix : `2033.080000` | ATR : `19.340000` (0.95%)
...
| Votes LONG / SHORT / HOLD | `34%` / `30%` / `36%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 30%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
