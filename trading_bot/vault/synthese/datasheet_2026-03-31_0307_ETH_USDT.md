...
> Généré le 31/03/2026 03:07 UTC | Prix : `2073.090000` | ATR : `24.092857` (1.16%)
...
| Votes LONG / SHORT / HOLD | `40%` / `34%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 34%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
