...
> Généré le 06/04/2026 13:37 UTC | Prix : `82.300000` | ATR : `0.767143` (0.93%)
...
| Votes LONG / SHORT / HOLD | `46%` / `19%` / `36%` |
...
**Note comportementale** : _📊 Distribution équilibrée (46%L / 19%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
