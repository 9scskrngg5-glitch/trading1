...
> Généré le 30/03/2026 21:02 UTC | Prix : `66638.540000` | ATR : `421.807857` (0.63%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.72% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 67059.7181 |
...
| Votes LONG / SHORT / HOLD | `39%` / `51%` / `10%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (39%/51%). Prudence : la foule a souvent tort contre la structure._
