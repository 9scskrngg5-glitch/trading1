...
> Généré le 31/03/2026 01:06 UTC | Prix : `82.720000` | ATR : `0.842857` (1.02%)
...
#### Sentiment Global
> POSITIVE — score `+23.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `34%` / `48%` / `18%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (34%/48%). Prudence : la foule a souvent tort contre la structure._
