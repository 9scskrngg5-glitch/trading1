...
> Généré le 31/03/2026 04:08 UTC | Prix : `2066.710000` | ATR : `23.229286` (1.12%)
...
| Votes LONG / SHORT / HOLD | `38%` / `25%` / `37%` |
...
**Note comportementale** : _📊 Distribution équilibrée (38%L / 25%S / 37%H). Pas de consensus clair — marché indécis selon le crowd._
