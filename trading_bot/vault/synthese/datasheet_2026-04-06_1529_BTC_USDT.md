...
> Généré le 06/04/2026 15:29 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
#### Sentiment Global
> NEUTRAL — score `-1.9` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `52%` / `12%` / `36%` |
| Probabilité haussière | `67%` |
| Probabilité baissière | `15%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `11%` |

**Note comportementale** : _📊 Distribution équilibrée (52%L / 12%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
