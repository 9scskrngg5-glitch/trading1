...
> Généré le 31/03/2026 00:26 UTC | Prix : `1.146500` | ATR : `0.001257` (0.11%)
...
#### Sentiment Global
> NEGATIVE — score `-27.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `29%` / `37%` / `33%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 37%S / 33%H). Pas de consensus clair — marché indécis selon le crowd._
