...
> Généré le 30/03/2026 21:03 UTC | Prix : `2023.200000` | ATR : `19.407143` (0.96%)
...
| Votes LONG / SHORT / HOLD | `40%` / `38%` / `22%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 38%S / 22%H). Pas de consensus clair — marché indécis selon le crowd._
