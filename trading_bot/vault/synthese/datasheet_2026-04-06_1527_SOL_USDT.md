...
> Généré le 06/04/2026 15:27 UTC | Prix : `82.230000` | ATR : `0.682857` (0.83%)
...
#### Sentiment Global
> POSITIVE — score `+37.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `40%` / `26%` / `34%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (40%/26%). Prudence : la foule a souvent tort contre la structure._
