...
> Généré le 31/03/2026 06:41 UTC | Prix : `83.770000` | ATR : `0.870714` (1.04%)
...
#### Sentiment Global
> NEGATIVE — score `-22.2` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `41%` / `35%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (41%L / 35%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
