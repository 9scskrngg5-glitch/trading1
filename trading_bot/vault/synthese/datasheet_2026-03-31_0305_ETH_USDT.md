...
> Généré le 31/03/2026 03:05 UTC | Prix : `2073.090000` | ATR : `24.092857` (1.16%)
...
| Votes LONG / SHORT / HOLD | `39%` / `30%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (39%L / 30%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
