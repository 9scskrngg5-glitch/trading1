...
> Généré le 06/04/2026 14:27 UTC | Prix : `69428.230000` | ATR : `391.775000` (0.56%)
...
| Votes LONG / SHORT / HOLD | `42%` / `18%` / `40%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (42%/18%). Prudence : la foule a souvent tort contre la structure._
