...
> Généré le 06/04/2026 04:34 UTC | Prix : `82.110000` | ATR : `0.831429` (1.01%)
...
#### ⚡ Scalping (5m–15m)
**Direction** : `LONG`
**Entrée** : 82.110000 (niveau courant)
**SL** : `81.777429` | **TP** : `82.775143` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
| Votes LONG / SHORT / HOLD | `30%` / `35%` / `35%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (30%/35%). Prudence : la foule a souvent tort contre la structure._
