...
> Généré le 30/03/2026 22:21 UTC | Prix : `66809.300000` | ATR : `448.105000` (0.67%)
...
| Votes LONG / SHORT / HOLD | `20%` / `36%` / `43%` |
...
**Note comportementale** : _📊 Distribution équilibrée (20%L / 36%S / 43%H). Pas de consensus clair — marché indécis selon le crowd._
