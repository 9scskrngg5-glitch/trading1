...
> Généré le 06/04/2026 23:29 UTC | Prix : `68811.000000` | ATR : `476.138571` (0.69%)
...
| Votes LONG / SHORT / HOLD | `42%` / `28%` / `29%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 28%S / 29%H). Pas de consensus clair — marché indécis selon le crowd._
