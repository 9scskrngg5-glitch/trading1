...
> Généré le 31/03/2026 06:07 UTC | Prix : `2064.310000` | ATR : `21.764286` (1.05%)
...
#### Détection de Biais
> ✅ Équilibré : 61% long / 39% short sur 18 signaux
...
| Votes LONG / SHORT / HOLD | `40%` / `29%` / `31%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 29%S / 31%H). Pas de consensus clair — marché indécis selon le crowd._
