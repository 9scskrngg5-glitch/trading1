...
> Généré le 06/04/2026 15:39 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
| Votes LONG / SHORT / HOLD | `53%` / `11%` / `36%` |
...
**Note comportementale** : _📊 Distribution équilibrée (53%L / 11%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
