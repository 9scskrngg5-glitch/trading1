...
> Généré le 31/03/2026 10:20 UTC | Prix : `1.147500` | ATR : `0.001079` (0.09%)
...
| Votes LONG / SHORT / HOLD | `33%` / `29%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 29%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
