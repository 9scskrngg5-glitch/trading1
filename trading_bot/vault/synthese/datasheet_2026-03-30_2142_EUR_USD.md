...
> Généré le 30/03/2026 21:42 UTC | Prix : `1.147400` | ATR : `0.001329` (0.12%)
...
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 1.1483 |
...
| Votes LONG / SHORT / HOLD | `23%` / `35%` / `42%` |
...
**Note comportementale** : _📊 Distribution équilibrée (23%L / 35%S / 42%H). Pas de consensus clair — marché indécis selon le crowd._
