...
> Généré le 31/03/2026 06:28 UTC | Prix : `1.147200` | ATR : `0.001050` (0.09%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.19% |
...
|---|---|---|---|
| R1 | `1.150892` | `100/100` | `12` touches |
...
- 🧱 Fake wall potentiel côté BID — OB imbalance +0.50 mais prix baisse

---

### 7. SENTIMENT & COHÉRENCE
#### Sentiment Global
> NEGATIVE — score `-23.9` sur 5 signaux fondamentaux
...
#### Détection de Biais
> ⚠️  BIAIS LONG DÉTECTÉ (73% des signaux) — Rechercher activement des setups SHORT. Réduire la taille des positions LONG de 20%.
...
#### ⚡ Scalping (5m–15m)
**Direction** : `RANGE`
**Entrée** : LONG @ 1.145300 | SHORT @ 1.150892
...
| Votes LONG / SHORT / HOLD | `29%` / `52%` / `19%` |
| Probabilité haussière | `37%` |
| Probabilité baissière | `53%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `-25` (-50 à +50) |
| Risque manipulation crowd | `7%` |

**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (29%/52%). Prudence : la foule a souvent tort contre la structure._
