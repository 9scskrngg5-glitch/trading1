...
> Généré le 31/03/2026 10:14 UTC | Prix : `66372.140000` | ATR : `546.654286` (0.82%)
...
|---|---|---|
| Direction | **BEARISH** | slope 20p = -1.86% |
| Type | **TRENDING** | volatilité medium |
| Phase (Wyckoff) | **MARKDOWN** | EMA20 = 67097.4616 |
| Volatilité ATR% | `0.82%` | 🟡 Moyenne |
| Force de tendance | `9/100` | |
...
| Indicateur | Valeur |
|---|---|
| Volatilité réalisée (VIX) | `7.8%` — 🟢 Faible (<30%) |
...
| Niveau | Prix | Force | Validations |
|---|---|---|---|
| S1 | `66195.695000` | `50/100` | `2` touches |
...
#### ⚡ Scalping (5m–15m)
**Direction** : `SHORT`
**Entrée** : 66372.140000 (niveau courant)
**SL** : `66590.801714` | **TP** : `65934.816571` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
#### ⚡ Scalping Contrarian
**Direction** : `LONG`
**Entrée** : 66195.695 (support S1)
**SL** : `65977.033286` | **TP** : `66633.018429` | **R:R** : `1:2.0`
**Timeframe** : `5m–15m`
...
#### 📊 Intraday (1h–4h)
**Direction** : `SHORT`
**Entrée** : Rebond vers 66645.467143 ou OB bearish
**SL** : `66918.794286` | **TP** : `65278.831429` | **R:R** : `1:2.0`
**Timeframe** : `1h–4h`
...
| Votes LONG / SHORT / HOLD | `40%` / `37%` / `23%` |
...
**Note comportementale** : _✅ Alignement foule-technique — 40% LONG avec support structurel. Consensus comportemental renforce l'analyse primaire._
