...
> Généré le 31/03/2026 05:46 UTC | Prix : `83.340000` | ATR : `0.871429` (1.05%)
...
| Votes LONG / SHORT / HOLD | `34%` / `36%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 36%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
