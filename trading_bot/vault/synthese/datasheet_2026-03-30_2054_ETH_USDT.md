...
> Généré le 30/03/2026 20:54 UTC | Prix : `2025.080000` | ATR : `19.407143` (0.96%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = +0.73% |
| Type | **RANGING** | volatilité medium |
| Phase (Wyckoff) | **TRANSITION** | EMA20 = 2041.8927 |
...
| Votes LONG / SHORT / HOLD | `26%` / `35%` / `39%` |
...
**Note comportementale** : _📊 Distribution équilibrée (26%L / 35%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
