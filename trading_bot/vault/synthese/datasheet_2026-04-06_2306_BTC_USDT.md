...
> Généré le 06/04/2026 23:06 UTC | Prix : `68811.000000` | ATR : `476.138571` (0.69%)
...
#### Sentiment Global
> POSITIVE — score `+26.7` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `40%` / `32%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (40%L / 32%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
