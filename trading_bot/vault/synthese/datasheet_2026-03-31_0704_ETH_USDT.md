...
> Généré le 31/03/2026 07:04 UTC | Prix : `2062.330000` | ATR : `21.315000` (1.03%)
...
#### Sentiment Global
> POSITIVE — score `+31.6` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `43%` / `31%` / `26%` |
...
**Note comportementale** : _📊 Distribution équilibrée (43%L / 31%S / 26%H). Pas de consensus clair — marché indécis selon le crowd._
