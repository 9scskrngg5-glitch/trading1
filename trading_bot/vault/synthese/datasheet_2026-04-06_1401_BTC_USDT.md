...
> Généré le 06/04/2026 14:01 UTC | Prix : `69428.230000` | ATR : `391.775000` (0.56%)
...
#### Sentiment Global
> POSITIVE — score `+31.5` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `43%` / `15%` / `42%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (43%/15%). Prudence : la foule a souvent tort contre la structure._
