...
> Généré le 31/03/2026 02:06 UTC | Prix : `2073.000000` | ATR : `23.675000` (1.14%)
...
| Votes LONG / SHORT / HOLD | `35%` / `40%` / `24%` |
...
**Note comportementale** : _📊 Distribution équilibrée (35%L / 40%S / 24%H). Pas de consensus clair — marché indécis selon le crowd._
