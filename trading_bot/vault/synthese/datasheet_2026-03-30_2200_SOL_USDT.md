...
> Généré le 30/03/2026 22:00 UTC | Prix : `83.190000` | ATR : `0.755000` (0.91%)
...
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 83.3297 |
| Volatilité ATR% | `0.91%` | 🟡 Moyenne |
...
| 🟢 OB Bullish @82.3300 | `81.960000` | `82.700000` | `82.330000` |
...
| Votes LONG / SHORT / HOLD | `42%` / `39%` / `19%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 39%S / 19%H). Pas de consensus clair — marché indécis selon le crowd._
