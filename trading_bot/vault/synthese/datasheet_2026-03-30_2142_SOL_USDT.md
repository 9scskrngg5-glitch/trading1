...
> Généré le 30/03/2026 21:42 UTC | Prix : `83.470000` | ATR : `0.815000` (0.98%)
...
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 83.3751 |
...
| Votes LONG / SHORT / HOLD | `33%` / `28%` / `39%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 28%S / 39%H). Pas de consensus clair — marché indécis selon le crowd._
