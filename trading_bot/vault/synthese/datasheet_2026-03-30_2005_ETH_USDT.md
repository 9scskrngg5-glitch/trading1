...
> Généré le 30/03/2026 20:05 UTC | Prix : `2023.700000` | ATR : `19.705000` (0.97%)
...
| Votes LONG / SHORT / HOLD | `42%` / `42%` / `16%` |
...
**Note comportementale** : _📊 Distribution équilibrée (42%L / 42%S / 16%H). Pas de consensus clair — marché indécis selon le crowd._
