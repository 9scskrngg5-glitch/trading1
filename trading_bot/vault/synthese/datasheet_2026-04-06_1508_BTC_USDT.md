...
> Généré le 06/04/2026 15:08 UTC | Prix : `69654.380000` | ATR : `398.368571` (0.57%)
...
|---|---|---|
| Technique | `bullish` | `51/100` |
| Fondamental | `bearish` | `39/100` |
| Régime | `bullish` | — |
| Structure | `bullish` | — |
...
| Votes LONG / SHORT / HOLD | `50%` / `14%` / `36%` |
| Probabilité haussière | `66%` |
| Probabilité baissière | `15%` |
| Signal Contrarian (>75%) | Non |
| Divergence vs Technique | `+0` (-50 à +50) |
| Risque manipulation crowd | `27%` |

**Note comportementale** : _📊 Distribution équilibrée (50%L / 14%S / 36%H). Pas de consensus clair — marché indécis selon le crowd._
