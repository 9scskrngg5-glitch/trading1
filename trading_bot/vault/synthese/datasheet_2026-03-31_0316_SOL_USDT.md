...
> Généré le 31/03/2026 03:16 UTC | Prix : `83.830000` | ATR : `0.927143` (1.11%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.23% |
| Type | **RANGING** | volatilité medium |
| Phase (Wyckoff) | **DISTRIBUTION** | EMA20 = 83.2968 |
| Volatilité ATR% | `1.11%` | 🟡 Moyenne |
...
| HVN (High Vol. Nodes) | `82.4615` | `83.3565` | `83.8935` |
...
> **🟢 Bullish (HH/HL)**
> 🔔 **BREAK OF STRUCTURE** détecté à `83.68`
...
#### Sentiment Global
> POSITIVE — score `+24.3` sur 5 signaux fondamentaux
...
- 🔔 Break of Structure à 83.68 — recalibrage recommandé
...
| Votes LONG / SHORT / HOLD | `33%` / `40%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (33%L / 40%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
