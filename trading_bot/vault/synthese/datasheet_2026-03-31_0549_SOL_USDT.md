...
> Généré le 31/03/2026 05:49 UTC | Prix : `83.340000` | ATR : `0.871429` (1.05%)
...
| Votes LONG / SHORT / HOLD | `29%` / `39%` / `32%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 39%S / 32%H). Pas de consensus clair — marché indécis selon le crowd._
