...
> Généré le 30/03/2026 20:56 UTC | Prix : `66664.730000` | ATR : `447.366429` (0.67%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = +0.02% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 67105.5673 |
...
| Votes LONG / SHORT / HOLD | `34%` / `37%` / `28%` |
...
**Note comportementale** : _📊 Distribution équilibrée (34%L / 37%S / 28%H). Pas de consensus clair — marché indécis selon le crowd._
