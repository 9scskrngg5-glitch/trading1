...
> Généré le 06/04/2026 13:10 UTC | Prix : `2143.590000` | ATR : `18.072143` (0.84%)
...
#### Sentiment Global
> NEUTRAL — score `+6.8` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `51%` / `19%` / `30%` |
...
**Note comportementale** : _📊 Distribution équilibrée (51%L / 19%S / 30%H). Pas de consensus clair — marché indécis selon le crowd._
