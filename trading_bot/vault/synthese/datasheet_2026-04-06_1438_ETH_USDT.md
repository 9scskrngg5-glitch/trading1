...
> Généré le 06/04/2026 14:38 UTC | Prix : `2145.990000` | ATR : `15.955000` (0.74%)
...
| Votes LONG / SHORT / HOLD | `41%` / `26%` / `32%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule neutral mais technique opposé. Crowd est contre-tendance (41%/26%). Prudence : la foule a souvent tort contre la structure._
