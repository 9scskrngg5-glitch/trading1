...
> Généré le 30/03/2026 23:59 UTC | Prix : `2033.080000` | ATR : `19.340000` (0.95%)
...
| Votes LONG / SHORT / HOLD | `29%` / `30%` / `40%` |
...
**Note comportementale** : _📊 Distribution équilibrée (29%L / 30%S / 40%H). Pas de consensus clair — marché indécis selon le crowd._
