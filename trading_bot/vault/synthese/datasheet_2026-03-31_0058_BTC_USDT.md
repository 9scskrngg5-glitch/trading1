...
> Généré le 31/03/2026 00:58 UTC | Prix : `66797.370000` | ATR : `455.454286` (0.68%)
...
#### Sentiment Global
> NEUTRAL — score `-15.4` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `15%` / `42%` / `42%` |
...
**Note comportementale** : _📊 Distribution équilibrée (15%L / 42%S / 42%H). Pas de consensus clair — marché indécis selon le crowd._
