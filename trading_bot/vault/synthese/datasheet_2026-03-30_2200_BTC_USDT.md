...
> Généré le 30/03/2026 22:00 UTC | Prix : `66834.000000` | ATR : `425.479286` (0.64%)
...
|---|---|---|
| Direction | **NEUTRAL** | slope 20p = -0.51% |
| Type | **RANGING** | volatilité low |
| Phase (Wyckoff) | **ACCUMULATION** | EMA20 = 67053.1770 |
| Volatilité ATR% | `0.64%` | 🟢 Faible |
...
| 🟢 OB Bullish @66448.8500 | `66233.130000` | `66664.570000` | `66448.850000` |
...
| Votes LONG / SHORT / HOLD | `37%` / `20%` / `43%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 20%S / 43%H). Pas de consensus clair — marché indécis selon le crowd._
