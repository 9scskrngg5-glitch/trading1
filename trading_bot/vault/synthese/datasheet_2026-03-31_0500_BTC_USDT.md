...
> Généré le 31/03/2026 05:00 UTC | Prix : `67544.010000` | ATR : `514.870714` (0.76%)
...
| Votes LONG / SHORT / HOLD | `27%` / `36%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 36%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
