...
> Généré le 31/03/2026 07:32 UTC | Prix : `67492.850000` | ATR : `504.093571` (0.75%)
...
| Votes LONG / SHORT / HOLD | `37%` / `42%` / `20%` |
...
**Note comportementale** : _📊 Distribution équilibrée (37%L / 42%S / 20%H). Pas de consensus clair — marché indécis selon le crowd._
