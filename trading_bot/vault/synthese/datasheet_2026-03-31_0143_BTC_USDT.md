...
> Généré le 31/03/2026 01:43 UTC | Prix : `67208.750000` | ATR : `498.372857` (0.74%)
...
| Votes LONG / SHORT / HOLD | `28%` / `46%` / `26%` |
...
**Note comportementale** : _🔀 Divergence comportementale — foule bearish mais technique opposé. Crowd est contre-tendance (28%/46%). Prudence : la foule a souvent tort contre la structure._
