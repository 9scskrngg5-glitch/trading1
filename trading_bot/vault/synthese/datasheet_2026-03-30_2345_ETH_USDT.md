...
> Généré le 30/03/2026 23:45 UTC | Prix : `2033.080000` | ATR : `19.340000` (0.95%)
...
#### Sentiment Global
> NEGATIVE — score `-20.0` sur 5 signaux fondamentaux
...
| Votes LONG / SHORT / HOLD | `27%` / `35%` / `38%` |
...
**Note comportementale** : _📊 Distribution équilibrée (27%L / 35%S / 38%H). Pas de consensus clair — marché indécis selon le crowd._
